...
// public functions
public function sizeOfText($text, $largeur)
{
    $index    = 0;
    $nb_lines = 0;
    $loop     = true;
...
public function addImage($logo_name, $location=array('10', '10', '0', '0'))
{
...
// Company
public function addCompany($nom, $address, $location='')
{
    $x1 = $location[0];
    $y1 = $location[1];
...
// bubble blocks
public function title($label, $total, $position)
{
    $r1  = $position[0];
    $r2  = $r1 + 19 + $position[2] ;
    $y1  = $position[1];
...
public function addTextBlock($title, $text, $positions)
{
    $r1  = $positions[0];
    $y1  = $positions[1];
    $this->SetXY($r1, $y1);
    ...
    public function tableWrapper($position)
    {
        $r1  = $position[0];
        $r2  = $r1 + 19 + $position[2] ;
        $y1  = $position[1];
    ...
    public function addBubble($page, $title, $position)
    {
        $r1  = $position[0];
        $r2  = $r1 + 19 + $position[2] ;
        $y1  = $position[1];
...
// bubble blocks
public function addBubbleBlock($page, $title, $position)
{
    $r1  = $position[0];
    $r2  = $r1 + 19 + $position[2] ;
    $y1  = $position[1];
...
// record blocks
public function addRecBlock($data, $title, $postion)
{
...
// description blocks
public function addDescBlock($data, $title, $position)
{
    $lengthtitle = strlen($title);
    ...
    public function drawLine($positions)
    {
        $x=$positions[0];
        $y=$positions[1];
        $width=$positions[2];
...
public function addCols($tab, $positions, $bottom, $taxtype = 'group')
{
    ...
    public function addProductLine($line, $tab, $totals='')
    {
    ...
    public function addTotalsRec($names, $totals, $positions)
    {
...
public function watermark($text, $positions, $rotate = array('45', '50', '180'))
{
