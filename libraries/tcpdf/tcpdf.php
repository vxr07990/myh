...
if (!class_exists('TCPDF', false)) {
    ...
    */
    ...
    Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
        ...
        * @access public
        */
        public function WordWrapText(&$text, $maxwidth)
        {
            $text = trim($text);
            if ($text==='') {
                return 0;
        ...
        * @access public
        */
        public function CheckPageBreakPDF($y_location)
        {
        ...
        * @access public
        */
        public function CheckPageBreakSummary($h)
        {
