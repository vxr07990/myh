...
class soapclient2 extends nusoap_base
{
    ...
    */
    public function soapclient2($endpoint, $wsdl = false, $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
    {
        ...
        $this->timeout = $timeout;
        $this->response_timeout = $response_timeout;
        $log->debug('Inside soapclient2 function: Before wsdl initialization');
    ...
    */
    ...
    {
        //@NOTE: HERE is where you can see what's sent into a eval function
        ...
        //@NOTE: $soapmsg is what's sent out.  This should be dumped if you're asked "what are you sending us?".
        // alternative print out could be in the send function.
    ...
    */
    public function getProxy()
    {
        ...
        //@NOTE: iff you want to print the sent body, look in function call for a note.
        ...
        // eval the class
        eval($evalStr);
        //Ensure the class was created so we don't fatal error.
        if (!class_exists("soap_proxy_$r")) {
            throw new Exception($evalStr);
        }
