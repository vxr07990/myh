 ...
 ********************************************************************************/
    ...
    */
    ...
    function writeErrorOutput($operationManager, $error)
    {
        ...
        echo $output;
        MoveCrm\LogUtils::LogToFile('LOG_CRM_WEBSERVICE', print_r($_REQUEST, true));
        MoveCrm\LogUtils::LogToFile('LOG_CRM_WEBSERVICE', print_r($error, true));
    }
    ...
    function writeOutput($operationManager, $data)
    {
        ...
        echo $output;
        MoveCrm\LogUtils::LogToFile('LOG_CRM_WEBSERVICE', print_r($_REQUEST, true));
        MoveCrm\LogUtils::LogToFile('LOG_CRM_WEBSERVICE', print_r($data, true));
    }
