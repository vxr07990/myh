jQuery.Class("ColorSettings_Js", {}, {
    ...
    updateValues: function (data) {
        ...
        var unassigned_color = $('#pickcolornoasignacion').val();
        var dataUrl = "index.php?module=OrdersTask&action=ColorSettingsSave&data_colores="+data+"&assigned_color="+assigned_color+"&unassigned_color="+unassigned_color;
        AppConnector.request(dataUrl).then(
            function (data) {
                if (data.success) {
                    ...
                    window.location.replace("index.php?module=OrdersTask&view=LongDistanceDispatch");
