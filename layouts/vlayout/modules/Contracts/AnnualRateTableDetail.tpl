{strip}
	...
	<table class="table table-bordered equalSplit detailview-table ">
		...
		<tbody id='annualRateIncreaseTable'>
			<tr>
				<td class="blockHeader" style='width:50%;text-align:center;'>{vtranslate("LBL_CONTRACTS_FROMDATE", $MODULE)}</td>
				<td class="blockHeader" style='width:50%;text-align:center;'>{vtranslate("LBL_CONTRACTS_PERCINCREASE", $MODULE)}</td>
			</tr>
