...
{strip}
    ...
    {assign var=MAPPED_TARGET_PICKLIST_VALUES value=array()}
    ...
    <input type="hidden" name="sourcefield" value='{$SOURCE_FIELD}' />
    <input type="hidden" name="selectedmodule" value='{$SELECTED_MODULE}' />

    <div class="row-fluid depandencyTable" style="overflow:scroll;">
        <div class="span3">
        ...
        <div class="span9 marginLeftZero dependencyMapping">
            <table class="table-bordered table-condensed themeTableColor pickListDependencyTable" style="width:100%;">
