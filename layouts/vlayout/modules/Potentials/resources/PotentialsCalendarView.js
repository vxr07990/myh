...
jQuery.Class("Potentials_CalendarView_Js", {
    ...
    getInstanceByView: function () {
        ...
        if (typeof window[moduleClassName] != 'undefined') {
            ...
            instance = new Potentials_CalendarView_Js();
        }
        return instance;
    },
    initiateCalendarFeeds: function () {
        Potentials_CalendarView_Js.performCalendarFeedIntiate();
    }
}, {
    calendarView: false,
    ...
    allocateColorsForAllUsers: function () {
        ...
        calendarfeeds.each(function (index, element) {
			...
			colorIndex ++;
			if(colorIndex > (approvedColors.lenght + 1)) colorIndex = 0;
    ...
    loadSharedCalendarUsers: function () {
        var instance = this;
        var url = 'module=Potentials&action=SharedCalendarUserList';
