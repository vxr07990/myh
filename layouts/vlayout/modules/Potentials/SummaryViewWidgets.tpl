    ...
    <div class="row-fluid calendar-wrapper">
        <div class="quickWidgetContainer accordion span2 user-column">
            <div class="quickWidget">
                <div class="accordion-heading accordion-toggle quickWidgetHeader">Available Users</div>
...
<script>
    {literal}
        jQuery(document).ready(function () {
            var instance = Potentials_CalendarView_Js.getInstanceByView();
            instance.registerEvents();
            instance.loadSharedCalendarUsers();

            Potentials_CalendarView_Js.currentInstance = instance;

            //Hidding the buttons that do not need to be shown
            $('.addButton').hide();
