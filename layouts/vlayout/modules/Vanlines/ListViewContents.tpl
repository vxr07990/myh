			...
			<td class="listViewEntryValue {$WIDTHTYPE}" data-field-type="{$LISTVIEW_HEADER->getFieldDataType()}" nowrap>
				...
				<div class="actions pull-right">
					<span class="actionImages">
						...
						{/if}
						{if $IS_MODULE_DELETABLE}{* OLD SECURITIES && $CURRENT_USER_MODEL->getExtraPermission($LISTVIEW_KEY)*}
							<a class="deleteVanlineRecordButton"><i title="{vtranslate('LBL_DELETE', $MODULE)}" class="icon-trash alignMiddle"></i></a>
						{/if}
					</span>
				</div></td>
				{/if}
