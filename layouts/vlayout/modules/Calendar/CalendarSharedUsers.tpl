...
<div name='calendarViewTypes'>
	...
	<div id="calendarview-feeds" style="margin-left:10px;">
		...
		<label class="checkbox addedCalendars" style="text-shadow: none">
			<input type="checkbox" data-calendar-sourcekey="Events33_{$CURRENT_USER_ID}" data-calendar-feed="Tasks/Events"
		...
		{foreach key=ID item=USER from=$SHAREDUSERS}
			{if $SHAREDUSERS_INFO[$ID]['visible'] != '0'}
				<label class="checkbox addedCalendars">
					<input type="checkbox" data-calendar-sourcekey="Events33_{$ID}" data-calendar-feed="Tasks/Events" data-calendar-userid="{$ID}" data-calendar-feed-color="{$SHAREDUSERS_INFO[$ID]['color']}">
