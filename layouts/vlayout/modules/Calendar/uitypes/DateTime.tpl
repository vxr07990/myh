...
{/if}
<div>
	{include file=vtemplate_path('uitypes/CalendarDate.tpl',$MODULE) BLOCK_FIELDS=$BLOCK_FIELDS FIELD_MODEL=$DATE_FIELD}
	{* WAS: include file=vtemplate_path('uitypes/Date.tpl',$MODULE) BLOCK_FIELDS=$BLOCK_FIELDS FIELD_MODEL=$DATE_FIELD *}
</div>
{if !empty($TIME_FIELD)}
<div>
