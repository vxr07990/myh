...
{include file="EditViewBlocks.tpl"|@vtemplate_path:'Actuals'}
{include file="EscrowsEdit.tpl"|@vtemplate_path:'Escrows'}
<br>
...
{else}
    ...
    {*include file="LineItemsEdit.tpl"|@vtemplate_path:'Actuals'*}
{/if}
