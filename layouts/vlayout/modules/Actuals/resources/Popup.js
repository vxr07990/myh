 ...
 * All Rights Reserved.
 *************************************************************************************/
// literally a copy of Estimates Popup.js (other than moduleName), as I can't derive from it here for some reason
	...
	show : function(urlOrParams, cb, windowName, eventName, onLoadCb){
		...
		if(this.getPopupStatus()){
			...
			if(loadDateUserFormat != ''){
				var dateFormat = jQuery('#' + Estimates_Popup_Js.I().moduleName + '_editView_fieldName_load_date').data('dateFormat');
				var y = '';
				var m = '';
				var d = '';
				for(var i = 0; i<10; i++){
