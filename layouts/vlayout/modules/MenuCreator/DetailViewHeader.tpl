						...
						<div class="pull-right detailViewButtoncontainer">
							...
							{foreach item=DETAIL_VIEW_BASIC_LINK from=$DETAILVIEW_LINKS['DETAILVIEWBASIC']}
								{if $DETAIL_VIEW_BASIC_LINK->get('linklabel') eq 'LBL_EDIT'}{* && $CREATOR_PERMISSIONS eq 'true'*}
									{if ($RECORD->get("description") eq 'DEFAULT_MENU' && $USER_MODEL->isAdminUser()) || $RECORD->get("description") neq 'DEFAULT_MENU'}
							...
							<span class="btn-group">
								...
								<ul class="dropdown-menu pull-right">
									...
									{if $DETAIL_VIEW_LINK->getLabel() eq ""} 
										<li class="divider"></li>	
									{else}
										{if $DETAIL_VIEW_LINK->getLabel() eq 'Delete Menu Creator'}
											{if $RECORD->get("description") neq 'DEFAULT_MENU'}
