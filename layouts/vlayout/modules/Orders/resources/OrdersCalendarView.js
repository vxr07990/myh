...
jQuery.Class("Orders_CalendarView_Js", {
    ...
    getInstanceByView: function () {
        ...
        if (typeof window[moduleClassName] != 'undefined') {
            ...
            instance = new Orders_CalendarView_Js();
        }
        return instance;
    },
    initiateCalendarFeeds: function () {
        Orders_CalendarView_Js.performCalendarFeedIntiate();
    }
}, {
    calendarView: false,
    ...
    vgsSlotClick: function (start, ends, jsEvent, view) {
        ...
        var potentialLabel = jQuery('.orders_no').html();
        ...
        var preQuickCreateSave = function (data) {
            ...
            thisInstance.setReferenceFieldValue(jQuery('[name="order_id"]').closest('td'), obj);
    ...
    loadSharedCalendarUsers: function () {
        var instance = this;
        var url = 'module=Orders&action=SharedCalendarUserList';
