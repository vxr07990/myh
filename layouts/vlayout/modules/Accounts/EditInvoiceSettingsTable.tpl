    ...
    <table class="table table-bordered blockContainer showInlineTable">
        ...
        <tr class="defaultInvoiceSetting hide" style="text-align:center">
            ...
            <td>
                <div class="row-fluid">
                    <span class="span12">
                        <select class="multipicklistall" multiple name="invoice_commodity[][]" style="width: 95%;">
        ...
        {foreach item=current_settings key=ROW_NUM from=$CURRENT_INVOICE_SETTINGS}
            ...
            <tr>
                ...
                <td>
                    <div class="row-fluid">
                    <span class="span10">
                        <select class="select2 multipicklistall" multiple name="invoice_commodity[{$COUNT}][]" style="max-width: 200px;">
                            ...
                            {*{/foreach}*}
                            {assign var="FIELD_VALUE_LIST" value=$current_settings.commodity}
