...
{strip}
	{foreach key=BLOCK_LABEL_KEY item=FIELD_MODEL_LIST from=$RECORD_STRUCTURE}
		{if $BLOCK_LABEL_KEY eq 'LBL_DESCRIPTION_INFORMATION' || ($BLOCK_LABEL_KEY eq 'LBL_ADDRESS_INFORMATION' && getenv('IGC_MOVEHQ'))}{continue}{/if}
		{if $BLOCK_LABEL_KEY eq 'LBL_ACCOUNT_BILLING_ADDRESS' && getenv('INSTANCE_NAME') == 'graebel'}
			{include file="DetailBillingAddressesTableGVL.tpl"|@vtemplate_path:$MODULE_NAME}
		{elseif $BLOCK_LABEL_KEY eq 'LBL_ACCOUNT_BILLING_ADDRESS' && getenv('IGC_MOVEHQ')}
			{include file="DetailBillingAddressesTable.tpl"|@vtemplate_path:$MODULE_NAME}
		{/if}
		{if $BLOCK_LABEL_KEY eq 'LBL_ACCOUNTS_ADDITIONAL_ROLES' && getenv('INSTANCE_NAME') == 'graebel'}
			{include file="DetailViewAdditionalRoles.tpl"|@vtemplate_path:$MODULE_NAME}{continue}
		{elseif $BLOCK_LABEL_KEY eq 'LBL_ACCOUNTS_ADDITIONAL_ROLES' && getenv('IGC_MOVEHQ')}
			{include file="DetailViewAdditionalRoles.tpl"|@vtemplate_path:$MODULE_NAME}{continue}
		{/if}
		{if $BLOCK_LABEL_KEY eq 'LBL_ACCOUNT_SALESPERSONS' && getenv('INSTANCE_NAME') == 'graebel'}
			{include file="DetailViewSalesPersonTable.tpl"|@vtemplate_path:$MODULE_NAME}{continue}
		{elseif $BLOCK_LABEL_KEY eq 'LBL_ACCOUNT_SALESPERSONS' && getenv('IGC_MOVEHQ')}
			{include file="DetailViewSalesPersonTable.tpl"|@vtemplate_path:$MODULE_NAME}{continue}
		{/if}
		{if $BLOCK_LABEL_KEY eq 'LBL_ACCOUNT_INVOICESETTINGS' && getenv('INSTANCE_NAME') == 'graebel'}
			{include file="DetailInvoiceSettingsTableGVL.tpl"|@vtemplate_path:$MODULE_NAME}
		{elseif $BLOCK_LABEL_KEY eq 'LBL_ACCOUNT_INVOICESETTINGS' && getenv('IGC_MOVEHQ')}
			{include file="DetailInvoiceSettingsTable.tpl"|@vtemplate_path:$MODULE_NAME}
		{/if}
	...
	{if $BLOCK_LABEL_KEY eq 'LBL_ACCOUNTS_ANNUALRATE' && $ANNUAL_RATES|@count gt 0}{include file="AnnualRateTableDetail.tpl"|@vtemplate_path:$MODULE_NAME}{/if}
