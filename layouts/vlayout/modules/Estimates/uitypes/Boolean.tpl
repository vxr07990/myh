...
{if $FIELD_NAME eq 'is_primary'} onclick="{if $LOCK_PRIMARY_FIELD}return false;{elseif $PARENT_HAS_PRIMARY}return Estimates_Edit_Js.primaryconf();{else}return Estimates_Edit_Js.checkParents();{/if}"{/if} />
{/strip}
