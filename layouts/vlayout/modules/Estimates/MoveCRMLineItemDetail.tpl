    ...
    <tr>
        ...
        {foreach key=SECTION_NAME item=LINEITEM_SECTION from=$LINEITEMS}
            ...
            <tr class="section_{str_replace(' ','_',$SECTION_NAME)} hide">
               ...
               <td class="narrowWidthType">
                    <div class="row-fluid" name="gross{$row_no}"><span class="add-on" style="margin-left: 8px">$</span><p class="pull-right" style="margin-top: 1px;margin-bottom: 1px">{number_format(str_replace(',','',$LINEITEM.Gross),2)}</p></div>
               ...
               <td class="narrowWidthType">
                    <div class="row-fluid" name="invoicecostnet{$row_no}"><span class="add-on" style="margin-left: 8px">$</span><p class="pull-right" style="margin-top: 1px;margin-bottom: 1px">{number_format(str_replace(',','',$LINEITEM.InvoiceCostNet), 2)}</p></div>
...
<td colspan="2" class="narrowWidthType">
    ...
    <td class="narrowWidthType">
        <b><span class="add-on" style="margin-left: 8px">$</span>
