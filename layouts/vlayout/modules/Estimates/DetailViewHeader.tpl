					...
					<div class="span7">
						<div class="pull-right detailViewButtoncontainer">
							...
							{foreach item=DETAIL_VIEW_BASIC_LINK from=$DETAILVIEW_LINKS['DETAILVIEWBASIC']}
								{if ($DETAIL_VIEW_BASIC_LINK->get('linklabel') eq 'LBL_EDIT' and  $RECORD->get('quotestage') neq 'Accepted') or $DETAIL_VIEW_BASIC_LINK->get('linklabel') eq 'LBL_ESTIMATES_CONVERT_ACTUAL'}{* && $CREATOR_PERMISSIONS eq 'true'*}
