	...
	<div class="reportContents">
		<form class="form-horizontal recordEditView" id="report_step1" method="post" action="index.php">
			...
			<div class="well contentsBackground">
				...
				<div class="row-fluid padding1per">
					<span class="span3">{vtranslate('LBL_OWNER_NAME', $MODULE)}<span class="redColor">*</span></span>
					<span class="span7 row-fluid">
					{include file='AgentPicklistStep1.tpl'|@vtemplate_path:$MODULE}
					</span>
				</div>
				...
				<div class="row-fluid padding1per">
					...
					<span class="span7 row-fluid">
						<input type="hidden" id="folderid" value="{$REPORT_MODEL->get('folderid')}"/>
