			...
			<div class="modal-body">
				...
				<div class="row-fluid verticalBottomSpacing">
					...
					<span class="span7 row-fluid">
						<input data-validation-engine='validate[required]' id="foldername" name="foldername" class="span12" type="text" value="{vtranslate($FOLDER_MODEL->getName(), $MODULE)}"/>
					</span>
				</div>
				<div class="row-fluid verticalBottomSpacing">
					<span class="span4">{vtranslate('LBL_OWNER_NAME', $MODULE)}<span class="redColor">*</span></span>
					<span class="span7 row-fluid">
					{include file='AgentPicklistFolder.tpl'|@vtemplate_path:$MODULE}
					</span>
				</div>
				<div class="row-fluid">
