...
{strip}
    ...
    {if $FOLDER_MODEL->getAgentid()}
        {assign var=SELECTED value=$FOLDER_MODEL->getAgentid()}
		{assign var=FIELD_VALUE value=$FOLDER_MODEL->getAgentid()}
    ...
    {/if}
    <select id="agentid" class="chzn-select" name="agentid" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-selected-value='{$FOLDER_MODEL->getAgentid()}'>
