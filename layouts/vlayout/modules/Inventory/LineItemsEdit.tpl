...
{strip}
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        <tr>
			...
			<th colspan="2" class="chznDropDown {if $MODULE_NAME eq "Quotes"}hide{/if}">
                <div class="row-fluid">
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemResult">
        <tr {if $MODULE_NAME eq "Quotes"}class='hide'{/if}>
            <td  width="83%">
		...
		<!-- Group Tax - starts -->
        <tr id="group_tax_row" valign="top" class="{if $IS_INDIVIDUAL_TAX_TYPE}hide{/if} {if $MODULE_NAME eq "Quotes"}hide{/if}">
            <td width="83%">
        ...
        <tr valign="top" {if $MODULE_NAME eq "Quotes"}class='hide'{/if}>
            <td width="83%" >
		...
		{if $MODULE eq 'Quotes' and ! isset($SOURCE_MODULE)}
		<tr valign="top">
			<td>
			</td>
			<td>
