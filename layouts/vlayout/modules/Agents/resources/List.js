...
Vtiger_List_Js("Agents_List_Js",{
    ...
    registerDeleteAgentRecordClickEvent: function(){
        var listViewContentDiv = this.getListViewContentContainer();
        listViewContentDiv.on('click','.deleteAgentRecordButton',function(e){
            var elem = jQuery(e.currentTarget);
            var recordId = elem.closest('tr').data('id');
            Agents_List_Js.deleteRecord(recordId);
            e.stopPropagation();
        });
    },
    registerAgentEvents : function(){
        var instance = new Agents_List_Js();
        instance.registerDeleteAgentRecordClickEvent();
    },
});
jQuery(document).ready(function(){
    var instance = new Agents_List_Js();
    instance.registerAgentEvents();
});