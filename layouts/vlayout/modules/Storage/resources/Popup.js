Vtiger_Popup_Js("Storage_Popup_Js", {}, {
    /**
    ...
    getCompleteParams: function () {
        ...
        params['storage_location'] = this.getStorageLocationType();
    ...
    getStorageLocationType: function () {
        var val = jQuery('[name="storage_location"]').val();
//        console.log(val);
        return val;
    },
    getSourceRecord : function(){
        var val = jQuery('[name="storage_orders"]').val();
        return val;
    },
