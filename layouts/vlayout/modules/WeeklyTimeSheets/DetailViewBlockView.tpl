...
{strip}
	...
	{if $BLOCK_LABEL_KEY neq 'LBL_CUSTOM_INFORMATION'}
...
<table class="table table-bordered equalSplit detailview-table ">
    <thead><tr><th class="blockHeader" colspan="7">&nbsp;&nbsp;Days Hours</th></tr></thead>
    <tbody>
        <tr>
            <td class="fieldLabel" style="width:14%;text-align:center;">Monday</td>
            <td class="fieldLabel" style="width:14%;text-align:center;">Tuesday</td>
            <td class="fieldLabel" style="width:14%;text-align:center;">Wednesday</td>
            <td class="fieldLabel" style="width:14%;text-align:center;">Thursday</td>
            <td class="fieldLabel" style="width:14%;text-align:center;">Friday</td>
            <td class="fieldLabel" style="width:14%;text-align:center;">Saturday</td>
            <td class="fieldLabel" style="width:14%;text-align:center;">Sunday</td>
        </tr>
        <tr>
            {foreach item=ARR from=$WeeklyTimeSheets}
            <td class="fieldValue" style="width:14%;text-align:center;">{$ARR.monday_hours}</td>
            <td class="fieldValue" style="width:14%;text-align:center;">{$ARR.tuesday_hours}</td>
            <td class="fieldValue" style="width:14%;text-align:center;">{$ARR.wednesday_hours}</td>
            <td class="fieldValue" style="width:14%;text-align:center;">{$ARR.thursday_hours}</td>
            <td class="fieldValue" style="width:14%;text-align:center;">{$ARR.friday_hours}</td>
            <td class="fieldValue" style="width:14%;text-align:center;">{$ARR.saturday_hours}</td>
            <td class="fieldValue" style="width:14%;text-align:center;">{$ARR.sunday_hours}</td>
            {/foreach}
        </tr>
    </tbody>
</table>      
