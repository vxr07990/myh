var AppHelper = {
    ...
    clearOverlayModal: function (data) {
        var blockMsg = data.closest('.blockUI.blockMsg');
        ...
        var modalContainer = $('#' + modalId + 'Container');
    ...
    customCssTag: function (css) {
        var head = $('head');
        head.append('<style type="text/css" id="customCssTag">' + css + '</style>');
    }
