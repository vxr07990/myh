...
<div class='container-fluid editViewContainer'>
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
		...
		{if ISSET($MODULE_MODEL)}
    <input type="hidden" id="duplicateCheckFields" value="{Vtiger_Util_Helper::toSafeHTML($MODULE_MODEL->getDuplicateCheckFields())}" />
		{/if}
		...
		{foreach key=BLOCK_LABEL item=BLOCK_FIELDS from=$RECORD_STRUCTURE name="EditViewBlockLevelLoop"}
			...
			{if $BLOCK_LABEL eq 'LBL_WFCONFIGURATION_SETUP'}
				{include file=vtemplate_path('EditView_UDFConfigurationBlock.tpl', $MODULE)}
                <br>
			{elseif $BLOCK_LABEL neq 'LBL_WFCONFIGURATION_DETAILS' && $BLOCK_LABEL neq 'LBL_RECORD_UPDATE_INFORMATION'}
                {include file=vtemplate_path('EditView_ConfigurationBlocks.tpl', $MODULE)}
                <br>
            {else}
