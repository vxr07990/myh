                            ...
                            {foreach item=DETAIL_VIEW_BASIC_LINK from=$DETAILVIEW_LINKS['DETAILVIEWBASIC']}
                                {if $DETAIL_VIEW_BASIC_LINK->get('linklabel') eq 'LBL_EDIT'}{* && $CREATOR_PERMISSIONS eq 'true'*}
                                    <span class="btn-group">
										<button class="btn btnDetailViewEdit" id="{$MODULE_NAME}_detailView_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores($DETAIL_VIEW_BASIC_LINK->getLabel())}"
                                            {if !$MODULE_MODEL->isCheckBeforeEditDeleteRequired()}
                                ...
                                {elseif $DETAIL_VIEW_BASIC_LINK->get('linklabel') neq 'LBL_EDIT'}
                                    <span class="btn-group">
