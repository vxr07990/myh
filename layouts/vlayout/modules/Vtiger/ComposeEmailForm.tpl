...
<div class="SendEmailFormStep2" id="composeEmailContainer">
	<div style='padding:10px 0;'>
		<h3>{vtranslate('LBL_COMPOSE_EMAIL', $MODULE)}<button class="close" aria-hidden="true" data-dismiss="modal" type="button" title="Close">x</button></h3>
	...
	<form class="form-horizontal" id="massEmailForm" method="post" action="index.php" enctype="multipart/form-data" name="massEmailForm">
		...
		<div class="paddingTop20 row-fluid boxSizingBorderBox">
			...
			{*if $MODULE_IS_ACTIVE*}
				<div class="span4">
				<input type="hidden" id='isMoveHQ' value='{$USER_MODEL->getMoveHQVersion()}'>
				<input type="hidden" id='versionNum' value='{$VTIGER_VERSION}'>
