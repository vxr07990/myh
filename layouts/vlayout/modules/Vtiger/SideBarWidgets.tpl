...
<div class="quickWidgetContainer accordion">
	...
	{foreach item=SIDEBARWIDGET key=index from=$QUICK_LINKS['SIDEBARWIDGET']}
		<div class="quickWidget">
			...
			<div class="widgetContainer accordion-body collapse {$SIDEBARWIDGET->getLabel()}" id="{$MODULE}_sideBar_{Vtiger_Util_Helper::replaceSpaceWithUnderScores($SIDEBARWIDGET->getLabel())}" data-url="{$SIDEBARWIDGET->getUrl()}">
			</div>
		</div>
	{/foreach}
</div>
