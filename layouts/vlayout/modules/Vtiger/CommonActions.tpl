                ...
                <div class="row-fluid">
                    <div class="searchElement span8">
                        ...
                        <div class="input-append searchBar">
                            {* results is deprecated and being removed on Chrome (M53 sept 2016) and not fully supported by other browsers.  Actually, it doesn't appear to do anything currently.
                            <input type="text" class="" id="globalSearchValue" placeholder="{vtranslate('LBL_GLOBAL_SEARCH')}" results="10" />
                            *}
                            <input type="text" class="" id="globalSearchValue" placeholder="{vtranslate('LBL_GLOBAL_SEARCH')}"/>
