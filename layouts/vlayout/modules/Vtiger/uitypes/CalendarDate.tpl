...
/*********************************************************************************
  ** The contents of this file are subject to the vtiger CRM Public License Version 1.0
   ...
   * All Rights Reserved.
  *
  * @TODO: I should be able to reference the vtiger date.tpl but I'm not sure how right now.
  *		When I figure it out I'll try and update this so it's just one format.
  *		-j
  *
 ********************************************************************************/
-->*}
