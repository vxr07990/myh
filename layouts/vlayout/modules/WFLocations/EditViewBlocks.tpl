...
<div class='container-fluid editViewContainer'>
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
		...
		<input type="hidden" name="base_location" value="false" />
        <input type="hidden" name="base_location_type" value="{$BASE_TYPE}"/>
		<input type="hidden" name="container_location" value="false" />
		<input type="hidden" name="locationPrefix" value="false" />
		<input type="hidden" name="action" value="Save" />
		<input type="hidden" name="record" value="{$RECORD_ID}" />
		<input type="hidden" name="lock_tag" value="{$LOCK_TAG}" />
