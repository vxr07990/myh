{strip}
    ...
    <input type="hidden" name="base_location" value={$BASE_LOCATION} />
    <input type="hidden" name="container_location" value={$CONTAINER_LOCATION} />
    <input type="hidden" name="base_location_type" value={$BASE_TYPE} />
