...
Settings_Workflows_Edit_Js("Settings_Workflows_Edit1_Js",{},{
	...
	registerSelectAllAgentsButton : function() {
		jQuery('#selectAllAgents').off('click').on('click', function() {
			jQuery('#agents > option').prop('selected','selected');
			jQuery('#agents').trigger('change');
		});
	},
	...
	registerEvents : function(){
		...
		this.registerSelectAllAgentsButton();
