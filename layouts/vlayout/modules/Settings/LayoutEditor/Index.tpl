                    ...
                    {if $IS_SORTABLE}
                        <div class="btn-toolbar">
                            ...
                            <span class="pull-right">
                                <button class="btn btn-success exportScript" type="button">
                                    <strong>{vtranslate('LBL_EXPORT_NEWFIELDS', $QUALIFIED_MODULE)}</strong>
                                </button>
    ...
    <form class="form-horizontal createCustomFieldForm" method="POST">
        <div class="modal-body">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" maxlength="50" name="fieldName" value="" data-validation-engine="validate[required, funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"
