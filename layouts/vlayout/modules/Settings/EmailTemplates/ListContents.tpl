	...
	<div class="emailTemplatesContainer">
		...
		<div style="padding:0 10px">
			<table class="table table-bordered table-condensed">
				...
				<tr data-dismiss="modal" class="listViewEntries" data-id="{$EMAIL_TEMPLATE->get('templateid')}" data-name="{$EMAIL_TEMPLATE->get('subject')}" data-info="{$EMAIL_TEMPLATE->get('body')}">
