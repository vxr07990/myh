									...
									<div class="row-fluid">
										...
										<div class="span11 commentorInfo">
											...
											<div class="inner">
												...
												{if $COMMENT->get('note_source') && $COMMENT->get('note_source') neq 'moveCRM'} <br><span class="commentorName"><strong>Source : </strong>{$COMMENT->get('note_source')}</span> {/if}
												{if $COMMENT->get('provider')} <br><span class="commentorName"><strong>Provider : </strong>{$COMMENT->get('provider')}</span> {/if}
												<br>
