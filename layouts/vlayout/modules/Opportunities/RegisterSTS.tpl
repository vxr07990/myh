...
<div class="modal-header contentsBackground">
    ...
    <h3>{vtranslate('LBL_STS_REGISTRATION', $MODULE)} : {$RECORD->getName()}</h3>
</div>
<button class="btn" id='submitSTSBtn'>
	<strong>Submit</strong>
</button>
<form class="form-horizontal recordEditView" name="RegisterSTS" method="post" action="index.php">
	...
	<div class="quickCreateContent">
		<div class="modal-body">
			{foreach key=BLOCK_LABEL item=FIELD_MODELS from=$REGISTER_STS_FIELDS}
