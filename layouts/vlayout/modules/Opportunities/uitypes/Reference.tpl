...
{if (($FIELD_NAME eq 'source_name' && $RECORD_MODEL && $RECORD_MODEL->get('lmp_lead_id') eq '') or $FIELD_NAME neq 'source_name')}
...
{if (($VIEW_NAME eq 'Edit') or ($MODULE_NAME eq 'Webforms')) && $FIELD_NAME neq 'source_name' && !in_array($REFERENCE_LIST[0],$QUICKCREATE_RESTRICTED_MODULES)}
