...
jQuery.Class("Vtiger_Detail_Js",{
	...
	registerEvents : function(){
		var thisInstance = this;
		//unbind enter from submiting form and refreshing the page
		$(window).keydown(function(event){if(event.keyCode == 13) {event.preventDefault();jQuery('.contents').trigger('click');return false;}});
		thisInstance.triggerDisplayTypeEvent();
