...
{/foreach}
{/strip}
{if $VIEWNAME=='ManagePayments'}<div style="text-align: center"><button class="btn-success" name="btnRecordPayment" id="btnRecordPayment" type="submit"><strong>{vtranslate('Record Payment', 'Payments')}</strong></button><br><br></div>{/if}
