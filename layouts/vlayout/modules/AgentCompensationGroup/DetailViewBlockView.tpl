...
{strip}
	...
	{if not $BLOCK->get('hideblock')}<br>{/if}
		{if $BLOCK_LABEL_KEY eq 'LBL_AGENTCOMPENSATION_GROUP'}
			{*include file=vtemplate_path('AgentCompensationItemsDetail.tpl', 'AgentCompensationItems')*}
			{include file=vtemplate_path('EscrowsDetail.tpl', 'Escrows')}
			<br>
		{/if}
	{/foreach}
