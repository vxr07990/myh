...
{strip}
	...
	<table class="table table-bordered listViewEntriesTable">
        ...
        {foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES name=popupListView}
            <tr class="listViewEntries" data-dismiss="modal" data-id="{$LISTVIEW_ENTRY->getId()}" data-name='{$LISTVIEW_ENTRY->getName()}'
                data-move_type="{$LISTVIEW_ENTRY->get('tariff_type')}"
