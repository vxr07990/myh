...
{strip}
	...
	{if $BLOCK_LABEL_KEY eq 'LBL_TARIFFMANAGER_ADMINISTRATIVE'}{include file="VanlineAgentTablesDetail.tpl"|@vtemplate_path:$MODULE_NAME}{/if}
	...
	<table class="table table-bordered equalSplit detailview-table {if $BLOCK->get('hideblock') eq true}hide{/if}">
		...
		{foreach item=FIELD_MODEL key=FIELD_NAME from=$FIELD_MODEL_LIST}
			{if !$FIELD_MODEL->isViewableInDetailView() || $FIELD_NAME eq 'custom_javascript'}
				 {continue}
			 {/if}
	...
	{include file="DetailValuationBlock.tpl"|@vtemplate_path:$MODULE}
