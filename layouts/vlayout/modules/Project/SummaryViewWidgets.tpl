...
{foreach item=DETAIL_VIEW_WIDGET from=$DETAILVIEW_LINKS['DETAILVIEWWIDGET']}
	...
	{elseif ($DETAIL_VIEW_WIDGET->getLabel() eq 'LBL_UPDATES')}
        ...
        {elseif ($DETAIL_VIEW_WIDGET->getLabel() eq 'Loading')}
            {assign var=LOADING_WIDGET_MODEL value=$DETAIL_VIEW_WIDGET}
        {elseif ($DETAIL_VIEW_WIDGET->getLabel() eq 'Transit')}
            {assign var=TRANSIT_WIDGET_MODEL value=$DETAIL_VIEW_WIDGET}
        {elseif ($DETAIL_VIEW_WIDGET->getLabel() eq 'Delivery')}
            {assign var=DELIVERY_WIDGET_MODEL value=$DETAIL_VIEW_WIDGET}
	{/if}
{/foreach}
...
<div class="row-fluid">
	...
	<div class='span5' style="overflow: hidden">
		...
		{if $LOADING_WIDGET_MODEL}
			<div class="summaryWidgetContainer">
				<div class="widgetContainer_tasks" data-url="{$LOADING_WIDGET_MODEL->getUrl()}" data-name="{$LOADING_WIDGET_MODEL->getLabel()}">
					<div class="widget_header row-fluid">
						<span class="span9">
							<div class="row-fluid">
								<span class="span4 margin0px"><h4>{vtranslate($LOADING_WIDGET_MODEL->getLabel(),$MODULE_NAME)}</h4></span>
								<span class="span7">
						...
						<span class="span3">
								...
								<button class="btn pull-right addButton addResource" id="Loading" type="button" data-url="{$LOADING_WIDGET_MODEL->get('actionURL')}" data-parent-related-field="projectid">
									<strong>{vtranslate('LBL_ADD',$MODULE_NAME)}</strong>
								</button>
							
						</span>
						<input type="hidden" name="relatedModule" value="{$LOADING_WIDGET_MODEL->get('linkName')}" />
					</div>
					<div class="widget_contents">
					</div>
				</div>
		...
		{* Summary View Loading Widget Ends Here *}
                ...
                {* Summary Transit Loading Widgte*}
		{if $TRANSIT_WIDGET_MODEL}
			<div class="summaryWidgetContainer">
				<div class="widgetContainer_tasks" data-url="{$TRANSIT_WIDGET_MODEL->getUrl()}" data-name="{$TRANSIT_WIDGET_MODEL->getLabel()}">
					<div class="widget_header row-fluid">
						<span class="span9">
							<div class="row-fluid">
								<span class="span4 margin0px"><h4>{vtranslate($TRANSIT_WIDGET_MODEL->getLabel(),$MODULE_NAME)}</h4></span>
								<span class="span7">
						...
						<span class="span3">
								...
								<button class="btn pull-right addButton addResource" id="Transit" type="button" data-url="{$TRANSIT_WIDGET_MODEL->get('actionURL')}" data-parent-related-field="projectid">
									<strong>{vtranslate('LBL_ADD',$MODULE_NAME)}</strong>
								</button>
							
						</span>
						<input type="hidden" name="relatedModule" value="{$TRANSIT_WIDGET_MODEL->get('linkName')}" />
					</div>
					<div class="widget_contents">
					</div>
				</div>
		...
		{/if}
		{* Summary View Transit Widget Ends Here *}
                
                
                {* Summary View Delivery Widgte*}
		{if $LOADING_WIDGET_MODEL}
			<div class="summaryWidgetContainer">
				<div class="widgetContainer_tasks" data-url="{$DELIVERY_WIDGET_MODEL->getUrl()}" data-name="{$DELIVERY_WIDGET_MODEL->getLabel()}">
					<div class="widget_header row-fluid">
						<span class="span9">
							<div class="row-fluid">
								<span class="span4 margin0px"><h4>{vtranslate($DELIVERY_WIDGET_MODEL->getLabel(),$MODULE_NAME)}</h4></span>
								<span class="span7">
						...
						<span class="span3">
								...
								<button class="btn pull-right addButton addResource" id="Delivery" type="button" data-url="{$DELIVERY_WIDGET_MODEL->get('actionURL')}" data-parent-related-field="projectid">
									<strong>{vtranslate('LBL_ADD',$MODULE_NAME)}</strong>
								</button>
							
						</span>
						<input type="hidden" name="relatedModule" value="{$DELIVERY_WIDGET_MODEL->get('linkName')}" />
					</div>
					<div class="widget_contents">
					</div>
				</div>
		...
		{/if}
		{* Summary View Delivery Widget Ends Here *}
