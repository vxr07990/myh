	...
	*/
    ...
    registerEventForAddingResourceFromSummaryWidget: function() {
        ...
        jQuery('.addResource').on('click', function(e) {
            ...
            var resourcesSearchURL = 'index.php?module=ResourceDashboard&view=ResourceSelect&projectid=' + parentId + '&projecttask=' + $(this).attr('id');
	...
	registerEvents : function(){
		...
		var thisInstance = this;
		this._super();
		this.initializeAddressAutofill('Project');
...
function editAssoc(crmid, taskid, qty) {
   
    window.location.href = 'index.php?module=ResourceDashboard&view=ResourceEdit&resourceid=' + crmid + '&allocatedqty=' + qty + '&projecttaskid=' + taskid + '&projectid=' + jQuery('#recordId').val();
