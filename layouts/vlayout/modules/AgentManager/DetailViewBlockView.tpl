...
{strip}
    {foreach key=BLOCK_LABEL_KEY item=FIELD_MODEL_LIST from=$RECORD_STRUCTURE}
        ...
        {if $VEHICLE_LOOKUP eq 'true' && $MODULE_NAME eq 'AgentManager' && $BLOCK_LABEL_KEY eq 'LBL_AGENTMANAGER_ADDRESSINFORMATION'}
            {include file=vtemplate_path('preShipChecklistDetail.tpl', 'VehicleLookup')}
        {/if}
	{/foreach}
    {if $ACCOUNTING_INTEGRATION_ACTIVE}
