...
<input type='hidden' name='module' value='AgentManager' />
<input type='hidden' name='action' value='SaveAgencyUser' />
...
{$SUB_ROLES = $CURRENT_USER->limitPicklistRoles($SUB_ROLES, 'AgentManager', $SRC_RECORD)}
	<thead>
