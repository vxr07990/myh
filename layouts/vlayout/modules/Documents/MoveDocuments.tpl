...
-->*}
{strip}
	<div class="modelContainer" style='min-width:350px;min-height:350px;'>
				...
				<div class="modal-body">
					<div class="row-fluid verticalBottomSpacing">
						...
						<span class="span8 row-fluid">
							<select class="chzn-select span11" name="foldername">
								<optgroup label="{vtranslate('LBL_FOLDERS', $MODULE)}">
									{foreach key=FOLDER item=FOLDER_NAME from=$FOLDERS_PICKLIST}
										<option value="{$FOLDER}">{vtranslate($FOLDER_NAME, $MODULE)}</option>
									{/foreach}
								</optgroup>
							</select>
						</span>
