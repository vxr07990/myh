...
Vtiger_List_Js("Documents_List_Js", {
	...
	folderSubmit : function() {
		...
		jQuery('#addDocumentsFolder').on('submit',function(e){
			...
			var agentManager = jQuery('#agentmanager_id').val();
			if(agentManager == 'default'){
				jQuery('#agentmanager_id').parent('.controls').validationEngine("showPrompt", "* This field is required", "error", "topRight", true);
