...
{strip}
    ...
    <table class="table table-bordered equalSplit detailview-table">
        <thead><tr>
                <th class="blockHeader">{vtranslate('LBL_AWSDOCS_PREVIEW',$MODULE_NAME)}</th></tr>
        </thead>
        <tbody>
            <tr>
                <td>
                    <iframe src="index.php?module=AWSDocs&action=DownloadFile&mode=preview&record={$RECORD->getId()}" width="100%" style="min-height:600px; border:none;"></iframe>
