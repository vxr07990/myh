...
{/if}
{if $FROM_WORKFLOWS}
    <input type="hidden" name="valuetype" value="reference" />
{/if}
...
{/if}
{if (($VIEW_NAME eq 'Edit') or ($MODULE_NAME eq 'Webforms')) && !in_array($REFERENCE_LIST[0],$QUICKCREATE_RESTRICTED_MODULES) && !in_array($REFERENCE_LIST[0], $MODULE_QUICKCREATE_RESTRICTIONS) && $FIELD_NAME neq 'source_name'}
