		...
		<div class="row-fluid detailViewTitle">
			<div class="{if $NO_PAGINATION} span12 {else} span10 {/if}">
				<div class="row-fluid">
					...
					<div class="span7">
						{if $UNSAVED_RECORD eq 1}
						<span class="pull-right" style="background-color:rgba(255,0,0,0.5); padding:5px">
							<strong>{vtranslate('LBL_UNSAVED_RECORD', 'PushNotifications')}</strong>
						</span>
						{/if}
					</div>
				</div>
