...
class WebserviceField
{
    ...
    public function getFieldDataType()
    {
        ...
        $fieldDataType = Vtiger_Cache::get('field_data_type', $this->fieldId);
        if (!$fieldDataType) {
            ...
            Vtiger_Cache::set('field_data_type', $this->fieldId, $this->fieldDataType);
        } else {
            $this->fieldDataType = $fieldDataType;
        }
    ...
    public function getReferenceList()
    {
        ...
        if ($this->referenceList === null) {
            ...
            if ($this->getUIType() != $this->genericUIType && $this->getUIType() != 1989 && $this->getUIType() != 1990 && $this->getUIType() != 1991) {
