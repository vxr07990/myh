...
*/
    ...
    public function getListViewNavigation($currentRecordId)
    {
        ...
        if ($reUseData === false && !empty($list_query)) {
            ...
            //@TODO : AHHHHHAAACK
            $list_query = preg_replace('/AND  OR/', ' OR ', $list_query);
    ...
    public function setSessionQuery($currentModule, $query, $viewid)
    {
