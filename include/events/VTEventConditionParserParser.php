...
class VTEventConditionParserParser extends AntlrParser
{
    ...
    public function comparision()
    {
        ...
        try {
            {
            $lhs=$this->match($this->input, $this->getToken('SYMBOL'), self::$FOLLOW_SYMBOL_in_comparision78); if ($this->state->failed) {
                return $result;
            }
            $this->match($this->input, $this->getToken('13'), self::$FOLLOW_13_in_comparision80); if ($this->state->failed) {
                return $result;
            }
    ...
    public function inclause()
    {
        ...
        try {
            {
            $lhs=$this->match($this->input, $this->getToken('SYMBOL'), self::$FOLLOW_SYMBOL_in_inclause101); if ($this->state->failed) {
                return $result;
            }
            $this->match($this->input, $this->getToken('IN'), self::$FOLLOW_IN_in_inclause103); if ($this->state->failed) {
                return $result;
            }
    ...
    public function listelement()
    {
        ...
        try {
            {
            $this->match($this->input, $this->getToken('14'), self::$FOLLOW_14_in_listelement122); if ($this->state->failed) {
                return $result;
            }
            ...
            do {
                ...
                case 1:
                    {
                    $this->match($this->input, $this->getToken('15'), self::$FOLLOW_15_in_listelement137); if ($this->state->failed) {
                        return $result;
                    }
            ...
            $this->match($this->input, $this->getToken('16'), self::$FOLLOW_16_in_listelement147); if ($this->state->failed) {
                return $result;
            }
    ...
    public function value()
    {
        ...
        try {
            {
            $val=$this->match($this->input, $this->getToken('STRING'), self::$FOLLOW_STRING_in_value162); if ($this->state->failed) {
                return $result;
            }
            if ($this->state->backtracking==0) {
