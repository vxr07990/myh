...
class VTCacheUtils
{
    ...
    public static function updateRecordOwner($record, $ownerId)
    {
        ...
        /** Record Agency Owner Id **/
        public static $_record_owner_agentid_cache = array();
    public static function lookupRecordAgentOwner($record)
    {
        if (isset(self::$_record_owner_agentid_cache[$record])) {
            return self::$_record_owner_agentid_cache[$record];
        }
        return false;
    }
        
    public static function updateRecordAgentOwner($record, $ownerId)
    {
        self::$_record_owner_agentid_cache[$record] = $ownerId;
    }
