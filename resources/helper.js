...
jQuery.Class("Vtiger_Helper_Js",{
	...
	getDateInstance : function(dateTime,dateFormat){
		...
		//the long way... ahah
		//if((year != 'undefined' && year.length > 4) || (month != 'undefined' && month.length > 2) || (date != 'undefined' && date.length > 2) || (dateInstance == null)){
    ...
    */
    ...
    checkEditableAndDeletable : function (details, search_params) {
        var aDeferred = jQuery.Deferred();
        ...
        var params = {
            ...
            mode: 'checkEditableAndDeletable',
            ids: details.ids
        };
        if(typeof details.actionword != 'undefined'){
            params.actionword = details.actionword;
        }
        if(typeof search_params != 'undefined') {
            params = jQuery.extend(params, search_params);
        }
        var response = false;
