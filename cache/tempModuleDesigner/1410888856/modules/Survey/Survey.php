...
class Survey extends Vtiger_CRMEntity
{
    public $table_name = 'vtiger_survey';
    public $table_index= 'surveyid';

    /**
     * Mandatory table for supporting custom fields.
     */
    public $customFieldTable = array('vtiger_surveycf', 'surveyid');

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    public $tab_name = array('vtiger_crmentity', 'vtiger_survey', 'vtiger_surveycf');
    ...
    public $tab_name_index = array(
        ...
        'vtiger_survey' => 'surveyid',
        'vtiger_surveycf'=>'surveyid');
    ...
    public $mandatory_fields = array('surveyid','assigned_user_id');
