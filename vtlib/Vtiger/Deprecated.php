...
class Vtiger_Deprecated
{
    ...
    public static function checkFileAccessForInclusion($filepath)
    {
        ...
        if (stripos($realfilepath, $rootdirpath) !== 0 || in_array($filePathParts[0], $unsafeDirectories)) {
            if (getenv('DISPLAY_ERRORS')) {
                die("Sorry! Attempt to access restricted file.\n<br>".'Filepath : '.$filepath."\n<br> Real Filepath : ".$realfilepath."\n<br> Root Dir Path : ".$rootdirpath."\n<br> Stack Trace : ".debug_backtrace(DEBUG_BACKTRACE_IGNORE_ARGS));
            }
            die("Sorry! Attempt to access restricted file.");
        }
    }
    ...
    public static function checkFileAccessForDeletion($filepath)
    {
        ...
        $realfilepath = realpath($filepath);
        //file_put_contents('logs/fileIncludes.log', date('Y-m-d H:i:s - ').$realfilepath."\n", FILE_APPEND);
