...
$accidentsblockInstance1 = Vtiger_Module::getInstance('LBL_ACCIDENTS_INFORMATION', $accidentsInstance);
...
$accidentsblockInstance2 = Vtiger_Module::getInstance('LBL_ACCIDENTS_RECORDUPDATE', $accidentsInstance);
