...
if ($field0) {
    ...
    $field0->typeofdata = 'V~O'; // Find Type of data here: https://wiki.vtiger.com/index.php/TypeOfData
...
$storageInstance = Vtiger_Module::getInstance('Orders');
$storageInstance->setRelatedList(Vtiger_Module::getInstance('Storage'), 'Storage', array('ADD'), 'get_related_list');
