...
$field1->label = 'Survey';
$field1->name = 'survey_id';
$field1->table = 'vtiger_project';
$field1->column = 'survey_id';
$field1->columntype = 'VARCHAR(50)';
$field1->uitype = 10;
$field1->typeofdata = 'V~O';

$block1->addField($field1);
$field1->setRelatedModules(array('Surveys'));
...
$module = Vtiger_Module::getInstance('Project');
$module->setRelatedList(Vtiger_Module::getInstance('Surveys'), 'Surveys', array('ADD', 'SELECT'), 'get_dependents_list');
