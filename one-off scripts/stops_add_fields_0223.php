...
$block1 = Vtiger_Block::getInstance('LBL_STOPS_INFORMATION', $module);  // Must
...
$field7->uitype = 16; // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
$field11->uitype = 16; // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
$field19->label = 'LBL_STOPS_ORDERS';
$field19->name = 'stop_order';
$field19->table = 'vtiger_stops';  // This is the tablename from your database that the new field will be added to.
$field19->column = 'stop_order';   //  This will be the columnname in your database for the new field.
$field19->columntype = 'VARCHAR(255)';
$field19->uitype = 10; // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
