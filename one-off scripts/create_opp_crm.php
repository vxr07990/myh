...
$field26 = Vtiger_Field::getInstance('destiantion_city', $opportunitiesInstance);
if ($field26) {
    ...
    $field26->name = 'destiantion_city';
    $field26->table = 'vtiger_potentialscf';
    $field26->column = 'destiantion_city';
...
if ($field28) {
    ...
    $field28->name = 'destiantion_state';
    $field28->table = 'vtiger_potentialscf';
    $field28->column = 'destiantion_state';
...
if ($field30) {
    ...
    $field30->name = 'destiantion_zip';
    $field30->table = 'vtiger_potentialscf';
    $field30->column = 'destiantion_zip';
...
$field34 = Vtiger_Field::getInstance('destiantion_phone2', $opportunitiesInstance);
if ($field34) {
    echo "<li>The destiantion_phone2 field already exists</li><br>";
} else {
    $field34 = new Vtiger_Field();
    $field34->label = 'LBL_POTENTIALS_DESTINATIONPHONE2';
    $field34->name = 'destiantion_phone2';
    $field34->table = 'vtiger_potentialscf';
    $field34->column = 'destiantion_phone2';
...
if ($field38) {
    ...
    $field38->label = 'LBL_POTENTIALS_DESTIANTIONADDRESSDESCRIPTION';
...
$field49 = Vtiger_Field::getInstance('decision_date', $opportunitiesInstance);
if ($field49) {
    echo "<li>The decision_date field already exists</li><br>";
} else {
    $field49 = new Vtiger_Field();
    $field49->label = 'LBL_POTENTIALS_DECISION';
    $field49->name = 'decision_date';
    $field49->table = 'vtiger_potentialscf';
    $field49->column = 'decision_date';
    $field49->columntype='DATE';
    $field49->uitype = 5;
    $field49->typeofdata = 'D~O';
    $field49->displaytype = 1;
...
$opportunitiesInstance->setRelatedList(Vtiger_Module::getInstance('Survey'), 'Survey Appointments', array('add'), 'get_related_list');
