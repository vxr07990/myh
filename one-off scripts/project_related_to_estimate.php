...
$field1->setRelatedModules(array('Estimate'));
...
$module = Vtiger_Module::getInstance('Project');
$module->setRelatedList(Vtiger_Module::getInstance('Estimate'), 'Estimate', array('ADD', 'SELECT'), 'get_dependents_list');
