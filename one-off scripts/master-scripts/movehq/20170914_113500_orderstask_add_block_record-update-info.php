...
if($blockInstance){
    echo "<h3>The LBL_RECORDUPDATEINFORMATION block already exists in Local Operations Tasks</h3><br> \n";
}else{
...
if($field1) {
    echo "<li>The createdtime field already exists in Local Operations Tasks </li><br> \n";
...
if($field2) {
    echo "<li>The modifiedtime field already exists in Local Operations Tasks </li><br> \n";
...
if($field3) {
    echo "<li>The createdby field already exists in Local Operations Tasks </li><br> \n";
