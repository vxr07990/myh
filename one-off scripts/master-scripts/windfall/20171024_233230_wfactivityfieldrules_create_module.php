...
$moduleName = 'WFActivityFieldRules';
...
$create = [$moduleName => [
    'LBL_'.strtoupper($moduleName).'_DETAILS' => [
        ...
        'LBL_'.strtoupper($moduleName).'_'.strtoupper('is_optional') => [
            'name' => 'is_optional',
            'table' => 'vtiger_'.strtolower($moduleName),
            'column' => 'is_optional',
            'uitype' => 56,
        ...
        'LBL_'.strtoupper($moduleName).'_'.strtoupper('type_of_rule') => [
            'name' => 'type_of_rule',
            'table' => 'vtiger_'.strtolower($moduleName),
            'column' => 'type_of_rule',
            'uitype' => 1,
            ...
            'sequence' => 3,
            'filterSequence' => 3,
            //'setPicklistValues' => ['alpha','yes','integer','notEmpty'],
            'defaultValue' => 'notEmpty'
        ],
        'LBL_'.strtoupper($moduleName).'_'.strtoupper('compare_value') => [
            'name' => 'compare_value',
            'table' => 'vtiger_'.strtolower($moduleName),
