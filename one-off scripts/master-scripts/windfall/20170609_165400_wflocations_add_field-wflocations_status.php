...
$moduleName = 'WFLocations';
$blockName = 'LBL_WFLOCATIONS_INFORMATION';
...
$field = Vtiger_Field::getInstance('wflocations_status', $module);
if ($field) {
    ...
    $field->label = 'LBL_WFLOCATIONS_STATUS';
    $field->name = 'wflocations_status';
    $field->table = 'vtiger_wflocations';
    $field->column = 'wflocations_status';
    ...
    echo '<p>Added wflocation_status field to WFLocations</p>';
}
