...
$create = ['WFTransactions' => [
            'LBL_WFTRANSACTIONS_DETAILS' => [
              'LBL_WFTRANSACTIONS_INVENTORY' => [
                'name' => 'inventory',
                'table' => 'vtiger_wftransactions',
                'column' => 'inventory',
              ...
              'LBL_WFTRANSACTIONS_LOCATIONTYPE' => [
                'name' => 'locationtype',
                'table' => 'vtiger_wftransactions',
                'column' => 'locationtype',
                'columntype' => 'varchar(255)',
              ...
              'LBL_WFTRANSACTIONS_LOCATIONTAG' => [
                'name' => 'locationtag',
                'table' => 'vtiger_wftransactions',
                'column' => 'locationtag',
                'columntype' => 'varchar(255)',
