...
$moduleName = 'WFActivityFields';

$create = [$moduleName => [
    'LBL_'.strtoupper($moduleName).'_DETAILS' => [
        'LBL_'.strtoupper($moduleName).'_'.strtoupper('input_fieldname') => [
            'name' => 'input_fieldname',
            'table' => 'vtiger_'.strtolower($moduleName),
            'column' => 'input_fieldname',
            'uitype' => 1,
            'typeofdata' => 'V~M',
        ...
        'LBL_'.strtoupper($moduleName).'_'.strtoupper('is_required') => [
            'name' => 'is_required',
            'table' => 'vtiger_'.strtolower($moduleName),
            'column' => 'is_required',
            'uitype' => 56,
