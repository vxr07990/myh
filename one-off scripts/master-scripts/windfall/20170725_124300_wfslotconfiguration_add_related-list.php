...
if($commentsModule) {
    ...
    $fieldInstance->setRelatedModules(['WFSlotConfiguration']);
    ModComments::removeWidgetFrom('WFSlotConfiguration'); //remove it before adding it because we can't tell if it already exists
    ModComments::addWidgetTo('WFSlotConfiguration');
}
