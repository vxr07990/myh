...
echo "Starting Hotfix_GVL_ParticipatingAgents_MakeFieldsMandatory.php.php<br/>\n";

$moduleName = 'ParticipatingAgents';
$fieldNames = [
'agents_id',
'agent_type'
];
...
foreach ($fieldNames as $fieldName) {
    ...
    ConvertToMandatoryPAMFM($moduleName, $fieldName);
}

function ConvertToMandatoryPAMFM($moduleName, $fieldName)
{
...
echo "Exiting Hotfix_GVL_ParticipatingAgents_MakeFieldsMandatory.php.php".PHP_EOL;
