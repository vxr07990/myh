...
$moduleName = 'Actuals';
$fieldNames = ['load_date', 'delivery_date'];



print "<h2>Begin modifications to Actuals date fields  </h2>\n";
foreach ($fieldNames as $fieldName) {
    AddMandatoryMLADDM($moduleName, $fieldName);
}
print "<h2>END modifications to Actuals date fields </h2>\n";

function AddMandatoryMLADDM($moduleName, $fieldName)
{
