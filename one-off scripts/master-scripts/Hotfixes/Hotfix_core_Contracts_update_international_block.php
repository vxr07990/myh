 ...
 *
 * create Block: International Information
 *
 * Add:
 * picklist: Origin Services (values undefined)
 * Booking Commissions Air %
 * picklist: Destination Services (values undefined)
 * Booking Commissions Sea %
 * Estimate Approval Required (checkbox)
 * US Flag Carrier Required (checkbox)
 *
...
$blockName = 'LBL_CONTRACTS_INTERNATIONAL_INFORMATION';
foreach (['Contracts'] as $moduleName) {
    ...
    if (!$module) {
        ...
        if ($block) {
            ...
            moveFields_CCUIB($moveFields, $module, $block->id);
            */
            //add these fields:
            $addFields = [
                'international_origin_services'      => [
                    'label'           => 'LBL_CONTRACTS_INTERNATIONAL_ORIGIN_SERVICES',
                    'name'            => 'international_origin_services',
                    'table'           => 'vtiger_contracts',
                    'column'          => 'international_origin_services',
                ...
                'booking_commission_air'             => [
                    'label'           => 'LBL_CONTRACTS_BOOKING_COMMISSION_AIR',
                    'name'            => 'booking_commission_air',
                    'table'           => 'vtiger_contracts',
                    'column'          => 'booking_commission_air',
                ...
                'international_destination_services' => [
                    'label'           => 'LBL_CONTRACTS_INTERNATIONAL_DESTINATION_SERVICES',
                    'name'            => 'international_destination_services',
                    'table'           => 'vtiger_contracts',
                    'column'          => 'international_destination_services',
                    'columntype'      => 'varchar(100)',
                    'uitype'          => 16,
                    'typeofdata'      => 'V~O',
                    'displaytype'     => '1',
                ...
                'booking_commission_sea'             => [
                    'label'           => 'LBL_CONTRACTS_BOOKING_COMMISSION_SEA',
                    'name'            => 'booking_commission_sea',
                    'table'           => 'vtiger_contracts',
                    'column'          => 'booking_commission_sea',
                    'columntype'      => 'varchar(15)',
                    'uitype'          => 9,
                    'typeofdata'      => 'N~O',
                    'displaytype'     => '1',
                ...
                'estimate_approval_required'         => [
                    'label'           => 'LBL_CONTRACTS_ESTIMATE_APPROVAL_REQUIRED',
                    'name'            => 'estimate_approval_required',
                    'table'           => 'vtiger_contracts',
                    'column'          => 'estimate_approval_required',
                ...
                'us_flag_carrier_required'           => [
                    'label'           => 'LBL_CONTRACTS_US_FLAG_CARRIER_REQUIRED',
                    'name'            => 'us_flag_carrier_required',
                    'table'           => 'vtiger_contracts',
                    'column'          => 'us_flag_carrier_required',
                    'columntype'      => 'varchar(3)',
                    'uitype'          => 56,
                    'typeofdata'      => 'C~O',
                    'displaytype'     => '1',
            ...
            addFields_CCUIB($addFields, $module);
            ...
            unhideFields_CCUIB($orderFieldSeq, $module);
            
            echo "<li>Reordering block $blockName</li><br>";
            reorderFieldsByBlock_CCUIB($orderFieldSeq, $blockName, $moduleName);

            //Hide these
            //$hideFields = [
            //];
            //hideFields_CCUIB ($hideFields, $module);
        }
        print "<h2>finished add fields to $moduleName module. </h2>\n";
    }
}

function moveFields_CCUIB($fields, $module, $newBlockID)
{
    if (is_array($fields)) {
...
//END process update
function hideFields_CCUIB($fields, $module)
{
    if (is_array($fields)) {
        $db = PearDatabase::getInstance();
        foreach ($fields as $field_name) {
...
function unhideFields_CCUIB($fields, $module)
{
    if (is_array($fields)) {
        $db = PearDatabase::getInstance();
        foreach ($fields as $field_name) {
...
//END process update
function addFields_CCUIB($fields, $module)
{
    $returnFields = [];
...
function reorderFieldsByBlock_CCUIB($fieldSeq, $blockLabel, $moduleName)
{
    $db = PearDatabase::getInstance();
...
function reorderBlocks_CCUIB($blockSeq, $module)
{
    $db = PearDatabase::getInstance();
