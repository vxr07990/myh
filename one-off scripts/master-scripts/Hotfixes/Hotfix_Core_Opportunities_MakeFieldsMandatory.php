...
print "<h2>Begin modifications to $moduleName fields  </h2>\n";
foreach ($fieldNames as $fieldName) {
    AddMandatoryCOMFM($moduleName, $fieldName);
}
print "<h2>END modifications to $moduleName fields </h2>\n";

function AddMandatoryCOMFM($moduleName, $fieldName)
{
