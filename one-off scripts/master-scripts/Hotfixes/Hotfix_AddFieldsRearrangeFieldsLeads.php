...
if ($block) {
    ...
    if ($field) {
        ...
        echo '<p>Added valuation_applied Field</p>';
    }
  ...
  /*  $field = Vtiger_Field::getInstance('billing_type', $module);
    ...
    // REORDER THE FIELDS
    $fieldOrder = ['business_line', 'leadsource', 'leadstatus', 'sales_person', 'agentid', 'assigned_user_id', 'billing_type', 'leadsource_workspace', 'leadsource_national'];
    $count = 1;
