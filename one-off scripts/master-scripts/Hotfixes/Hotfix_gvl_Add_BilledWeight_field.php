 ...
 *
 *Goals:
 * Add Billed Weight to Estimates (quotes) under the
 *
...
foreach (['Estimates', 'Quotes'] as $moduleName) {
    print "<h2>START add Extra fields to $moduleName module. </h2>\n";
    ...
    if (!$module) {
        ...
        if (!$block) {
            ...
            $fields   = [
                'billed_weight' => [
                    'label'           => 'LBL_QUOTES_BILLED_WEIGHT',
                    'name'            => 'billed_weight',
                    'table'           => 'vtiger_quotes',
                    'column'          => 'billed_weight',
                    'columntype'      => 'INT(10)',
                    'uitype'          => 7,
                    'typeofdata'      => 'C~O',
                    //'summaryfield' => 1,
            ...
            $fieldSeq = [
                ...
                'full_pack'                 => '4',
                'full_unpack'               => '5',
                'bottom_line_discount'      => '7',
                'interstate_mileage'        => '8',
                'linehaul_disc'             => '10',
                'accessorial_disc'          => '11',
                'packing_disc'              => '12',
                'sit_disc'                  => '13',
                'interstate_effective_date' => '14',
                'pricing_type'              => '15',
                'irr_charge'                => '47'
            ];
            if ($moduleName == 'Quotes') {
                $fieldSeq = [
                    ...
                    'full_pack'                 => '10',
                    'rate_estimate'             => '11',
                    'interstate_mileage'        => '12',
                    'irr_charge'                => '13',
                    'linehaul_disc'             => '14',
                    'accessorial_disc'          => '15',
                    'packing_disc'              => '16',
                    'sit_disc'                  => '17',
                    'interstate_effective_date' => '18',
                    'pricing_type'              => '19',
                ];
            }
