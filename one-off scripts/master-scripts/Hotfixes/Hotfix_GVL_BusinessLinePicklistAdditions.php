...
// OT 3204 - Add new choices into the Business Line dropdown with HHG - International Surface and Commercial - International Air

//$Vtiger_Utils_Log = true;
//include_once('vtlib/Vtiger/Menu.php');
//include_once('vtlib/Vtiger/Module.php');

echo "<br>Starting Hotfix to Update Business Line Picklist<br/>\n";
...
echo "<br>Finished Hotfix to Update Business Line Picklist<br/>\n";
