...
echo "<br>BEGINNING Hotfix: Modify Stop Description for Graebel<br>";

$db = PearDatabase::getInstance();

$db->pquery('TRUNCATE TABLE `vtiger_extrastops_description`', []);
$db->pquery('UPDATE `vtiger_extrastops_description_seq` SET id=0', []);
$db->pquery('TRUNCATE TABLE `vtiger_origin_description`', []);
$db->pquery('UPDATE `vtiger_origin_description_seq` SET id=0', []);
$db->pquery('TRUNCATE TABLE `vtiger_destination_description`', []);
$db->pquery('UPDATE `vtiger_destination_description_seq` SET id=0', []);

/*$moduleName = 'ExtraStops';
$picklistFieldName = 'extrastops_description';*/
//NOTE: this wouldn't work if they weren't all different modules
$modFields = [
    'ExtraStops'    => 'extrastops_description',
    'Orders' => 'origin_description',
    'Leads' => 'destination_description',
];
...
foreach ($modFields as $moduleName => $picklistFieldName) {
    $module = Vtiger_Module::getInstance($moduleName);
    echo "<br>Modifying $moduleName $picklistFieldName<br>";
...
$db->pquery('UPDATE `vtiger_field` SET uitype = 16 WHERE (fieldname="origin_description" OR fieldname="destination_description") AND (tabid=7 OR tabid=2 OR tabid=60)', []);

echo "<br>COMPLETED Hotfix: Modify Stop Description for Graebel<br>";
