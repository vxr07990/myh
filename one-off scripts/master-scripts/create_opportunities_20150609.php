...
$opportunitiesblock1 = Vtiger_Block::getInstance('LBL_POTENTIALS_INFORMATION', $opportunitiesInstance);
if ($opportunitiesblock1) {
    echo "<li>The LBL_POTENTIALS_INFORMATION field already exists</li><br>";
} else {
    $opportunitiesblock1 = Vtiger_Block::getInstance('LBL_OPPORTUNITY_INFORMATION', $opportunitiesInstance);
    if ($opportunitiesblock1) {
        $opportunitiesblock1->label = 'LBL_POTENTIALS_INFORMATION';
        $opportunitiesblock1->save();
    } else {
...
$field28 = Vtiger_Field::getInstance('destination_state', $opportunitiesInstance);
if ($field28) {
...
$field30 = Vtiger_Field::getInstance('destination_zip', $opportunitiesInstance);
if ($field30) {
...
if ($field046) {
    ...
    $field046->label = 'LBL_POTENTIALS_PDDELIVER';
...
$opportunitiesblock5 = Vtiger_Block::getInstance('LBL_POTENTIALS_PARTICIPANTS', $opportunitiesInstance);
if ($opportunitiesblock5) {
    echo "<li>The LBL_POTENTIALS_PARTICIPANTS field already exists</li><br>";
} else {
    $opportunitiesblock5 = new Vtiger_Block();
    $opportunitiesblock5->label = 'LBL_POTENTIALS_PARTICIPANTS';
    $opportunitiesblock5->sequence = 1;
    $opportunitiesInstance->addBlock($opportunitiesblock5);
}

if (!Vtiger_Utils::CheckTable('vtiger_potential_participatingagents')) {
    echo "<li>creating vtiger_potential_participatingagents </li><br>";
    Vtiger_Utils::CreateTable('vtiger_potential_participatingagents',
                              '(opportunityid INT(10),
								agentid INT(10),
                                agenttype INT(15),
...
$opportunitiesInfo = Vtiger_Block::getInstance('LBL_POTENTIALS_INFORMATION', $opportunitiesInstance);
if ($opportunitiesInfo) {
    ...
    if ($opportunitiesSalesPerson) {
        echo "<br> opportunities sales person field already exists.<br>";
    } else {
        echo "<br> opportunities sales person field doesn't exist, adding it now.<br>";
...
if ($isNew) {
    ...
    $filter1->addField($field1)->addField($field10, 1)->addField($field4, 2)->addField($field20, 3)->addField($field11, 4)->addField($field3, 5)->addField($opportunitiesSalesPerson, 6);
    ...
    $opportunitiesInstance->setRelatedList(Vtiger_Module::getInstance('Estimates'), 'Estimates', array('add'), 'get_quotes');
