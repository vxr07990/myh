...
$blockcf = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if(!$blockcf) {
...
$field1 = Vtiger_Field::getInstance('message', $moduleInstance);
if(!$field1) {
...
$field2 = Vtiger_Field::getInstance('status', $moduleInstance);
if(!$field2) {
...
$field3 = Vtiger_Field::getInstance('description', $moduleInstance);
if(!$field3) {
