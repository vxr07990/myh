...
$timesheetsblockInstance1 = Vtiger_Block::getInstance('LBL_TIMESHEETS_INFORMATION', $timesheetsInstance);
...
$timesheetsblockInstance2 = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $timesheetsInstance);
...
$field1 = Vtiger_Field::getInstance('timesheet_id', $timesheetsInstance);
    if ($field1) {
        ...
        $entity->setModuleSeqNumber('configure', $timesheetsInstance->name, 'TS', 1);
    }
...
$field7 = Vtiger_Field::getInstance('actual_start_date', $timesheetsInstance);
    ...
    if ($field10) {
        ...
        $field10->columntype = 'DECIMAL(12,1)';
        $field10->uitype = 7;
...
echo "<br> timesheets complete. <br>";
