...
if ($field0) {
    ...
    $field0->label = 'LBL_EMPLOYEES_ASSIGNEDTO';
...
if ($field2) {
    ...
    $module1->setEntityIdentifier($field2);
}
...
if ($field3) {
    ...
    $field3->typeofdata = 'V~M';                                // Find Type of data here: https://wiki.vtiger.com/index.php/TypeOfData
...
if ($field5) {
    ...
    $field5->uitype = 11;                                        // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
if ($field6) {
    ...
    $field6->uitype = 11;                                        // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
//adding four fields date_out,date_in,time_out,time_in

$field01 = Vtiger_Field::getInstance('date_out', $module1);
if ($field01) {
    echo "<li> the date_out field already exists</li><br>";
} else {
    $field01 = new Vtiger_Field();
    $field01->label = 'LBL_EMPLOYEES_DATEOUT';
    $field01->name = 'date_out';
    $field01->table = 'vtiger_employees';
    $field01->column = 'date_out';
    $field01->columntype = 'DATE';
    $field01->uitype = 5;
    $field01->typeofdata = 'D~O';

    $block1->addField($field01);
}

$field02 = Vtiger_Field::getInstance('time_out', $module1);
if ($field02) {
    echo "<li> the field time_out already exists</li><br>";
} else {
    $field02 = new Vtiger_Field();
    $field02->label = 'LBL_EMPLOYEES_TIMEOUT';
    $field02->name = 'time_out';
    $field02->table = 'vtiger_employees';
    $field02->column = 'time_out';
    $field02->columntype = 'TIME';
    $field02->uitype = 14;
    $field02->typeofdata = 'T~O';

    $block1->addField($field02);
}

$field03 = Vtiger_Field::getInstance('date_in', $module1);
if ($field03) {
    echo "<li> the field date_in already exists</li><br>";
} else {
    $field03 = new Vtiger_Field();
    $field03->label = 'LBL_EMPLOYEES_DATEIN';
    $field03->name = 'date_in';
    $field03->table = 'vtiger_employees';
    $field03->column = 'date_in';
    $field03->columntype = 'DATE';
    $field03->uitype = 5;
    $field03->typeofdata = 'D~O';

    $block1->addField($field03);
}

$field04 = Vtiger_Field::getInstance('time_in', $module1);
if ($field04) {
    echo "<li> the field time_in already exists<li><br>";
} else {
    $field04 = new Vtiger_Field();
    $field04->label = 'LBL_EMPLOYEES_TIMEIN';
    $field04->name = 'time_in';
    $field04->table = 'vtiger_employees';
    $field04->column = 'time_in';
    $field04->columntype = 'TIME';
    $field04->uitype = 14;
    $field04->typeofdata = 'T~O';
}
...
if ($field16) {
    ...
    $field16->uitype = 16;                                        // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
if ($field19) {
    ...
    $field19->uitype = 16;                                        // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
if ($field25) {
    ...
    $field25->uitype = 16; // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
if ($field34) {
    ...
    $field34->uitype = 11;                                        // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
if ($field35) {
    ...
    $field35->columntype = 'VARCHAR(20)';
    $field35->uitype = 11;                                        // FIND uitype here: https://wiki.vtiger.com/index.php/UI_Types
...
echo "<ul>";
$field75 = Vtiger_Field::getInstance('trailer', $module1);
if ($field75) {
    echo "<li>The trailer field already exists</li><br>";
} else {
    $field75 = new Vtiger_Field();
    $field75->label = 'LBL_EMPLOYEES_TRAILER';
    $field75->name = 'trailer';
    $field75->table = 'vtiger_employees';
    $field75->column = 'trailer';
    $field75->columntype = 'VARCHAR(100)';
    $field75->uitype = 1;
    $field75->typeofdata = 'V~O';

    $block10->addField($field75);
}

echo "<ul>";
$field76 = Vtiger_Field::getInstance('fleet_type', $module1);
if ($field76) {
    echo "<li>The fleet_type field already exists</li><br>";
} else {
    ...
    $field76->setPicklistvalues(array('None'));
}

echo "<ul>";
$field77 = Vtiger_Field::getInstance('carb_compliant', $module1);
if ($field77) {
    echo "<li>The carb_compliant field already exists</li><br>";
} else {
    $field77 = new Vtiger_Field();
    $field77->label = 'LBL_CARB_COMPLIANT';
    $field77->name = 'carb_compliant';
    $field77->table = 'vtiger_employees';
    $field77->column = 'carb_compliant';
...
echo "<ul>";
$field80 = Vtiger_Field::getInstance('notes', $module1);
if ($field80) {
    echo "<li>The notes field already exists</li><br>";
} else {
    $field80 = new Vtiger_Field();
    $field80->label = 'LBL_EMPLOYEES_NOTES';
    $field80->name = 'notes';
    $field80->table = 'vtiger_employees';
    $field80->column = 'notes';
    $field80->columntype = 'TEXT';
    $field80->uitype = 19;
...
echo "<ul>";
$field81 = Vtiger_Field::getInstance('isqualify', $module1);
if ($field81) {
    echo "<li>The isqualify field already exists</li><br>";
} else {
    $field81 = new Vtiger_Field();
    $field81->label = 'LBL_EMPLOYEES_ISQUALIFY';
    $field81->name = 'isqualify';
    $field81->table = 'vtiger_employees';
    $field81->column = 'isqualify';
    $field81->columntype = 'VARCHAR(3)';
    $field81->uitype = 56;
    $field81->typeofdata = 'C~O';
...
$filter1->addField($field2)->addField($field3, 1)->addField($field15, 2)->addField($field5, 3)->addField($field6, 4)->addField($field4, 5);

$filter2 = new Vtiger_Filter();
$filter2->name = 'Contractors';
$filter2->isdefault = true;
$module1->addFilter($filter2);

$filter2->addField($field1)->addField($field2, 1)->addField($field3, 2)->addField($field5, 3)->addField($field6, 4)->addField($field4, 5)->addRule($field1, 'EQUALS', 'Contractor');
...
Vtiger_Utils::ExecuteQuery('UPDATE `vtiger_customview` SET status = 0 WHERE entitytype  = "Employees" AND viewname = "Contractors" ');

    echo "<h2>Setting group_condition= and  & condition_expression = 0 in cvadvfilter_grouping table</h2><br>";
Vtiger_Utils::ExecuteQuery("INSERT INTO `vtiger_cvadvfilter_grouping` (`groupid`, `cvid`, `group_condition`, `condition_expression`) VALUES ( 1, 68, 'and' , '0' )");
