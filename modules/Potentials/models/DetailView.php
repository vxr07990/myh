...
class Potentials_DetailView_Model extends Vtiger_DetailView_Model
{
    ...
    public function getDetailViewLinks($linkParams)
    {
        ...
        $cubesheetModuleModel = Vtiger_Module_Model::getInstance('Cubesheets');
        ...
        if ($currentUserModel->hasModuleActionPermission($surveyModuleModel->getId(), 'EditView')) {
            $basicActionLink = array(
                'linktype' => 'DETAILVIEW',
        ...
        if ($currentUserModel->hasModuleActionPermission($cubesheetModuleModel->getId(), 'EditView')) {
            $basicActionLink = array(
                'linktype' => 'DETAILVIEW',
                'linklabel' => vtranslate('LBL_CREATE').' '.vtranslate($cubesheetModuleModel->getSingularLabelKey(), 'Cubesheets'),
                'linkurl' => $recordModel->getCreateCubesheetUrl(),
                'linkicon' => ''
            );
            $linkModelList['DETAILVIEW'][] = Vtiger_Link_Model::getInstanceFromValues($basicActionLink);
        }
        ...
        if ($currentUserModel->hasModuleActionPermission($projectModuleModel->getId(), 'EditView')) {
            $basicActionLink = array(
                'linktype' => 'DETAILVIEW',
                'linklabel' => vtranslate('LBL_CREATE').' '.vtranslate($projectModuleModel->getSingularLabelKey(), 'Project'),
