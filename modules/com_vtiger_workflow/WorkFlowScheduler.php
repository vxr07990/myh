                    ...
                    foreach ($tasks as $task) {
                        if ($task->active) {
                            ...
                            if ($task->executeImmediately == true) {
                                \MoveCrm\LogUtils::LogToFile('LOG_WORKFLOW', 'Immediate Task');
                                \MoveCrm\LogUtils::LogToFile('LOG_WORKFLOW', $task);
                                $task->doTask($entityData);
                            } else {
                                \MoveCrm\LogUtils::LogToFile('LOG_WORKFLOW', 'Queue Task, Delay: ' . $delay);
                                \MoveCrm\LogUtils::LogToFile('LOG_WORKFLOW', $task);
