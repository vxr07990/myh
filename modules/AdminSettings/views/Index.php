...
class AdminSettings_Index_View extends Vtiger_Basic_View
{
    ...
    public function process(Vtiger_Request $request)
    {
        if (!Settings_Vtiger_Index_View::$loadOlderSettingUi) {
            ...
            $agentInfo               = AdminSettings_Module_Model::getAgentSettigs();
            $viewer->assign('AGENT_INFO', $agentInfo);
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $jsFileNames           = [
            ...
            'modules.AdminSettings.resources.Index',
        ];
