...
class OrdersTask_Popup_View extends Vtiger_Popup_View
{
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        if (($request->get('popup_type') != '' && $request->get('popup_type') == 'local_dispatch_related')) {
            $searchParmams[0][] = ['dispatch_status', 'e', 'Accepted'];
        }
