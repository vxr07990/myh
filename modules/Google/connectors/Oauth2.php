...
class Google_Oauth2_Connector
{
    ...
    public function __construct($module, $userId=false)
    {
        ...
        $stringToAppend = (substr($site_URL, -1) == '/') ? 'index.php?module=Google&view=List&operation=sync&sourcemodule=' : '/index.php?module=Google&view=List&operation=sync&sourcemodule=';
        $this->redirect_uri = $site_URL . $stringToAppend .
