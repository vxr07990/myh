...
class SMS_Response_Request
{
    ...
    /**
     * function to return the keys for the rawvaluemap
     */
    public function getRawKeys()
    {
        return array_keys($this->rawvaluemap);
    }

    /**
     * function to return the keys for the valuemap
     */
