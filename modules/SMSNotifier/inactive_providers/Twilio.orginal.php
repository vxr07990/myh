...
{
    private $userName; // Twilio uses AccountSid for this field
    private $password; // Twilio uses AuthToken for this field
    private $parameters = array('From' => '');//The from #.
