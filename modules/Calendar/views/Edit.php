...
class Calendar_Edit_View extends Vtiger_Edit_View
{
    ...
    public function Events($request, $moduleName)
    {
        ...
        $viewer->assign('OCCURRENCE', $recordModel->isOccurrence());
        $viewer->assign('RECURRENCE_ROOT', $recordModel->getRecurrenceRoot());
        ...
        if (!empty($requestContactIdValue)) {
            $existingRelatedContacts[] = ['name' => Vtiger_Util_Helper::getRecordName($requestContactIdValue), 'id' => $requestContactIdValue];
        }
