...
//	public function vtlib_handler($eventType)
//	{
//		global $adb;
//
//		if ($eventType == 'vtiger.entity.afterCreateNewCalendarEvent') {
//			$em = new VTEventsManager($adb);
//			$em->registerHandler($eventType,
//				'modules/Calendar/CreateNewCalendarEventHandler.php',
//				'CreateNewCalendarEventHander',
//				'Calendar');
//		} else if ($eventType == 'vtiger.entity.afterUpdateCalendarEvent') {
//			$em = new VTEventsManager($adb);
//			$em->registerHandler($eventType,
//				'modules/Calendar/UpdateCalendarEventHandler.php',
//				'UpdateCalendarEventHandler',
//				'Calendar');
//		} else if ($eventType == 'vtiger.entity.afterDeleteCalendarEvent') {
//			$em = new VTEventsManager($adb);
//			$em->registerHandler($eventType,
//				'modules/Calendar/DeleteCalendarEventHandler.php',
//				'DeleteCalendarEventHandler',
//				'Calendar');
//		} else if ($eventType == 'module.postinstall') {
//			$this->addWidgetForSync();
//		} else if ($eventType == 'module.disabled') {
//			$this->removeWidgetForSync();
...
//	 */
//	protected function addWidgetForSync($widgetType = 'LISTVIEWSIDEBARWIDGET') {
//
//		$widgetName = 'Microsoft Exchange';
//		$module = Vtiger_Module::getInstance('Calendar');
//		if ($module) {
//			$module->addLink($widgetType, $widgetName, "module=EwsTest&view=List", '', '', '');
//		}
//
//	}
//
...
//	 * @param String $widgetType
//	 * @internal param String $widgetName
//	 */
//	function removeWidgetForSync($widgetType = 'LISTVIEWSIDEBARWIDGET') {
//
//		$widgetName = 'Microsoft Exchange';
//		$module = Vtiger_Module::getInstance('Calendar');
//		if ($module) {
