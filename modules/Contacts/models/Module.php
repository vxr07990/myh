    ...
    public function getSideBarLinks($linkParams)
    {
        ...
        $parentQuickLinks['SIDEBARLINK'][] = Vtiger_Link_Model::getInstanceFromValues(
            array(
                ...
                'linklabel' => 'LBL_TRANSFEREES',
                'linkurl' => 'index.php?module=Contacts&view=TransfereesContacts',
                'linkicon' => '',
        ...
        $parentQuickLinks['SIDEBARLINK'][] = Vtiger_Link_Model::getInstanceFromValues(
            array(
                'linktype' => 'SIDEBARLINK',
                'linklabel' => 'LBL_VANLINES',
                'linkurl' => 'index.php?module=Contacts&view=VanlinesContacts',
                'linkicon' => '',
        ...
        $parentQuickLinks['SIDEBARLINK'][] = Vtiger_Link_Model::getInstanceFromValues(
            array(
                'linktype' => 'SIDEBARLINK',
                'linklabel' => 'LBL_AGENTS',
                'linkurl' => 'index.php?module=Contacts&view=AgentsContacts',
                'linkicon' => '',
        ...
        $parentQuickLinks['SIDEBARLINK'][] = Vtiger_Link_Model::getInstanceFromValues(
            array(
                'linktype' => 'SIDEBARLINK',
                'linklabel' => 'LBL_ACCOUNTS',
                'linkurl' => 'index.php?module=Contacts&view=AccountsContacts',
                'linkicon' => '',
