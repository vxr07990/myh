...
class Contacts_VanlinesContacts_View extends Vtiger_List_View
{
    protected $default_local_dispatch_view; //Harcode the filter that show the local dispatch tasks

    public function __construct()
    {
        parent::__construct();
        $this->default_local_dispatch_view = Contacts_ListView_Model::getCvId('Van Lines');
    }
