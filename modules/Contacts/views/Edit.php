...
class Contacts_Edit_View extends Vtiger_Edit_View
{
    public function process(Vtiger_Request $request)
    {
        ...
        $viewer->assign('CONTACT_TYPE', $recordModel->get('contact_type'));
        $contactTypeMap = [
            "customer_number" => "Transferee",
            "account_id" => "Account",
            "vanlines" => "Vanline",
            "agents" => "Agent"
        ];
        $viewer->assign('TYPE_FIELD_MAP', $contactTypeMap);
        ...
        if(getenv('INSTANCE_NAME') != 'sirva') {
            $viewer->assign('MODULE_QUICKCREATE_RESTRICTIONS', ['Accounts', 'Agents', 'Vanlines']);
        }
