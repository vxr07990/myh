...
class Tariffs_ListView_Model extends  Vtiger_ListView_Model {
    /**
...
//                $InValuesSql = implode(',',$agentIdsRecord);
//            }
//
//            $position = stripos($listQuery, ' GROUP BY ');
//            if ($position) {
//                $split = spliti(' GROUP BY ', $listQuery);
//                $removeLastAndWHERE = explode(' AND ',$split[0]);
//                $keyLastAndWHERE = end(array_keys($removeLastAndWHERE));
//                unset($removeLastAndWHERE[$keyLastAndWHERE]);
//                $split[0] = implode(' AND ',$removeLastAndWHERE);
//                $listQuery = $split[0]. " AND vtiger_crmentity.agentid IN ($InValuesSql) GROUP BY " .$split[1];
//            }else{
//                $listQuery .= " AND vtiger_crmentity.agentid IN ($InValuesSql)'";
//            }
//        }
