...
{
    public $table_name = 'vtiger_contractors';
    public $table_index= 'contractorsid';

    /**
     * Mandatory table for supporting custom fields.
     */
    public $customFieldTable = array('vtiger_contractorscf', 'contractorsid');

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    public $tab_name = array('vtiger_crmentity', 'vtiger_contractors', 'vtiger_contractorscf');
    ...
    public $tab_name_index = array(
        ...
        'vtiger_contractors' => 'contractorsid',
        'vtiger_contractorscf'=>'contractorsid');
