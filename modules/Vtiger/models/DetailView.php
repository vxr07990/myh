...
class Vtiger_DetailView_Model extends Vtiger_Base_Model
{
    ...
    public function getDetailViewLinks($linkParams)
    {
        ...
        //utilize the vtiger_links table to add/remove these links per module.
    ...
    public function getDetailViewRelatedLinks()
    {
        ...
        foreach ($relationModels as $relation) {
            ...
            if (participantRelationAccessible($moduleName, $relation->valueMap['modulename'], $recordModel->getId())) {
                $relatedLinks[] = $link;
            }
        }
