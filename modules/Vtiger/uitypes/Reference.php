    ...
    public function getDisplayValue($value)
    {
        ...
        if ($referenceModule && !empty($value)) {
            ...
            if ($referenceModuleName == 'Users') {
                ...
                {
                    $entityNames[$value] = '-- No Label --';
                }
                $linkValue = "<a href='index.php?module=$referenceModuleName&view=".$referenceModule->getDetailViewName()."&record=$value'
							title='".vtranslate($referenceModuleName, $referenceModuleName)."'>";
                $linkValue .= ($referenceModuleName == 'EffectiveDates') ? DateTimeField::convertToUserFormat($entityNames[$value]) : $entityNames[$value];
                $linkValue .= "</a>";
                return $linkValue;
            }
        }
