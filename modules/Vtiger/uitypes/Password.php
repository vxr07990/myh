...
class Vtiger_Password_UIType extends Vtiger_Base_UIType
{
    ...
    {
        return bin2hex(openssl_encrypt($value, 'AES-128-CBC', getenv('EXCHANGE_SALT'), OPENSSL_RAW_DATA));
    }
    ...
    {
        return openssl_decrypt(hex2bin($value), 'AES-128-CBC', getenv('EXCHANGE_SALT'), OPENSSL_RAW_DATA);
    }
}
