...
class Vtiger_Datetime_UIType extends Vtiger_Date_UIType
{
    ...
    public static function getDateTimeValueInTimeZone($dateTime, $timeZone) {
        return Vtiger_Util_Helper::convertDateTimeIntoUsersDisplayFormatInTimeZone($dateTime, $timeZone);
    }
}
