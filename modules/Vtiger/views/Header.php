...
abstract class Vtiger_Header_View extends Vtiger_View_Controller
{
    ...
    public function getHeaderLinks()
    {
            ...
            [
                ...
                'childlinks' => [
                    [
                        ...
                        'linkurl'   => 'http://www.igcsoftware.com/',
                        'linkicon'  => '',
                        'target'    => '_blank',
                    ],
                    [
                    ...
                    [
                        'linktype'  => 'HEADERLINK',
                        'linklabel' => 'LBL_FEEDBACK',
                        'linkurl'   => "javascript:window.open('http://www.igcsoftware.com/')",
                        'linkicon'  => '',
                    ],
                ],
            ],
        ...
        if ($userModel->isAdminUser() || $userModel->isParentVanLineUser() || ($userModel->isAgencyAdmin() && getenv('INSTANCE_NAME') == 'uvlc')) {
            $crmSettingsLink = [
                'linktype'   => 'HEADERLINK',
                ...
                'childlinks' => [
                    [
                        'linktype'  => 'HEADERLINK',
                        'linklabel' => 'LBL_CRM_SETTINGS',
                        'linkurl'   => '?module=System&parent=Settings&view=Index',
                        'linkicon'  => '',
                    ],
                    [], // separator
                    [
            ...
            $picklistCustomizerModel = Vtiger_Module_Model::getInstance('PicklistCustomizer');
            if ($picklistCustomizerModel && $picklistCustomizerModel->isActive()) {
                $crmSettingsLink['childlinks'][] = []; //Add separator
                $crmSettingsLink['childlinks'][] = [
                    'linktype'  => 'HEADERLINK',
                    'linklabel' => 'LBL_PICKLISTCUSTOMIZER',
                    'linkurl'   => 'index.php?module=PicklistCustomizer&view=Edit',
                    'linkicon'  => '',
                ];
            }
            array_push($headerLinks, $crmSettingsLink);
        }else if ($userModel->isAgencyAdmin() && getenv('INSTANCE_NAME') != 'uvlc') {
            $crmSettingsLink = [
                'linktype'   => 'HEADERLINK',
                'linklabel'  => 'LBL_CRM_SETTINGS',
                'linkurl'    => '',
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $customLink = new Vtiger_Link_Model;
        $customLink->set('href', 'layouts/vlayout/skins/tightview/sirva.css');
        $customLink->set('rel', 'stylesheet');
        $headerCssInstances[] = Vtiger_CssScript_Model::getInstanceFromLinkObject($customLink);
