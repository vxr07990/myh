...
class VanlineManager_SaveAjax_Action extends Vtiger_SaveAjax_Action
{
    public function process(Vtiger_Request $request)
    {
        ...
        foreach ($fieldModelList as $fieldName => $fieldModel) {
            if ($fieldName == 'vanline_name') {
                //update vanline group name
                $agent = $recordModel->get($fieldName);
    ...
    public function getRecordModelFromRequest(Vtiger_Request $request)
    {
        ...
        if (!empty($recordId)) {
            ...
            $fieldModelList = $recordModel->getModule()->getFields();
            //file_put_contents('logs/SaveLog.log', date("Y-m-d H:i:s")." - ".print_r($fieldModelList, true)."\n", FILE_APPEND);
            foreach ($fieldModelList as $fieldName => $fieldModel) {
