...
class Opportunities_RegisterSTS_View extends Vtiger_Index_View
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        $viewer->view('RegisterSTS.tpl', $moduleName);
    }
}
