...
class AgentManager_DetailView_Model extends Vtiger_DetailView_Model
{
    ...
    public function getDetailViewLinks($linkParams)
    {
        ...
        $roleDepth = $currentUserModel->getUserRoleDepth();

        //override to hide the duplicate button from sales manager since they have edit view but shouldn't duplicate.
        if (Users_Privileges_Model::isPermitted($moduleName, 'EditView', $recordId) && $roleDepth < 4) {
    ...
    public function getDetailViewRelatedLinks()
    {
        ...
        //coordinators temporarily removed
        /* $relatedLinks[] = array(
                'linktype' => 'DETAILVIEWTAB',
                'linklabel' => 'LBL_COORDINATORS',
                'linkurl' => $recordModel->getDetailViewUrl().'&mode=manageCoordinators',
                'linkicon' => ''
        ); */
