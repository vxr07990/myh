...
class MailManager_Relation_View extends MailManager_Abstract_View
{
     ...
     * @var Array
     */
    public static $MODULES = ['Contacts', 'Accounts', 'Leads'];
        ...
        if ('find' == $this->getOperationArg($request)) {
            ...
            if (empty($linkedto)) {
                ...
                foreach (self::$MODULES as $MODULE) {
                    ...
                    $modules[$MODULE] = ['label' => $describe['label'], 'name' => textlength_check($describe['name']), 'id' => $describe['idPrefix']];
    ...
    {
        $moduleListForCreateRecordFromMail = ['Contacts', 'Accounts', 'Leads', 'HelpDesk', 'Calendar'];
    ...
    {
        $moduleListForLinkTo = ['Calendar', 'HelpDesk', 'ModComments', 'Emails'];
