...
class MailManager_List_View extends MailManager_Abstract_View
{
    public static $controllers = [
        'mainui'   => ['file' => 'controllers/MainUIController.php', 'class' => 'MailManager_MainUI_View'],
        'folder'   => ['file' => 'controllers/FolderController.php', 'class' => 'MailManager_Folder_View'],
        'mail'     => ['file' => 'controllers/MailController.php', 'class' => 'MailManager_Mail_View'],
        'relation' => ['file' => 'controllers/RelationController.php', 'class' => 'MailManager_Relation_View'],
        'settings' => ['file' => 'controllers/SettingsController.php', 'class' => 'MailManager_Settings_View'],
        'search'   => ['file' => 'controllers/SearchController.php', 'class' => 'MailManager_Search_View'],
    ];
