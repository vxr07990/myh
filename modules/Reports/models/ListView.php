    ...
    public function getListViewLinks()
    {
        ...
        if ($currentUserModel->isAdminUser() || $privileges->hasModulePermission($this->getModule()->getId())) {
            $basicLinks = array(
                    ...
                    array(
                        'linktype' => 'LISTVIEWBASIC',
                        'linklabel' => 'VIEW_CUSTOM_REPORTS',
                        'linkurl' => '',
                        'linkicon' => '',
                        'childlinks' => array(
                            array(
                                'linktype' => 'LISTVIEWBASIC',
                                'linklabel' => 'LBL_REPORTS_GVL_CUSTOM1',
                                'linkurl' => $this->getModule()->getDetailViewUrl(0),
                                'linkicon' => ''
                            ),
                            array(
                                'linktype' => 'LISTVIEWBASIC',
                                'linklabel' => 'LBL_REPORTS_GVL_CUSTOM2',
                                'linkurl' => $this->getModule()->getDetailViewUrl(-1),
                                'linkicon' => ''
                            ),
                            array(
                                'linktype' => 'LISTVIEWBASIC',
                                'linklabel' => 'LBL_REPORTS_GVL_CUSTOM3',
                                'linkurl' => $this->getModule()->getDetailViewUrl(-2),
                                'linkicon' => ''
                            ),
                            array(
                                'linktype' => 'LISTVIEWBASIC',
                                'linklabel' => 'LBL_REPORTS_GVL_CUSTOM4',
                                'linkurl' => $this->getModule()->getDetailViewUrl(-3),
                                'linkicon' => ''
                            ),
                        )
                    )
