...
class Reports_Module_Model extends Vtiger_Module_Model
{
    ...
    public function getFoldersByOwnerId($folderID)
    {
        return Reports_Folder_Model::getAllByOwnerId($folderID);
    }    
    
    public function getFoldersByOwner()
    {
        return Reports_Folder_Model::getAllByOwner();
    }
}
