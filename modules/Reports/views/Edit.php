...
class Reports_Edit_View extends Vtiger_Edit_View
{
    ...
    public function checkPermission(Vtiger_Request $request)
    {
        ...
        if ($record) {
            ...
            if (!$reportModel->isEditable() && !(\MoveCrm\InputUtils::CheckboxToBool($request->get('isDuplicate')))) {
                throw new AppException('LBL_PERMISSION_DENIED');
            }
        }
    }
    ...
    public function step1(Vtiger_Request $request)
    {
        ...
        $reportFolderModels = $reportModuleModel->getFoldersByOwnerId($request->get('folder'));
