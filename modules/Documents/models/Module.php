...
class Documents_Module_Model extends Vtiger_Module_Model
{
    ...
    {
        //return 'view=Popup&module=Documents&src_module=Emails&src_field=composeEmail'; - Updated 5/25/2016
        return 'module=Documents&view=Popup';
    }
    ...
    public function getSettingLinks()
    {
        ...
        if ($this->hasSequenceNumberField()) {
            $settingsLinks[] = array(
                ...
                'linkurl' => 'index.php?parent=Settings&module=System&view=CustomRecordNumbering&sourceModule='.$this->getName(),
                    'linkicon' => ''
            );
        }
