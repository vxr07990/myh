            ...
            if (count($templates) > 0) {
                foreach ($templates as $templateId) {
                    if ($templateId != "0" && $templateId != "") {
                        ...
                        $saveId = $transactionRecordModel->saveTransaction($id, $templateId, $module, $entityId, $signature, $signatureName, $full_content, $description);
                        ...
                        if (!empty($keys_values)) {
                            ...
                            $saveId = $transactionRecordModel->saveTransaction($saveId, $templateId, $module, $entityId, $signature, $signatureName, $full_content, $description);
                        }
                        ...
                        if ($this->check_attach_file != null) {
                            ...
                            $templateSetting = $settingRecordModel->findByTemplateId($quotingToolRecord->getId());
