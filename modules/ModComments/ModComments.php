...
class ModComments extends ModCommentsCore
{
    ...
    public function saveentity($module, $fileid='')
    {
        ...
        $parentModuleName = getSalesEntityType($related_to);

        if ($parentModuleName == 'Opportunities' || $parentModuleName == 'Leads') {
            $this->column_fields['cf_comment_type'] = '1';
        } elseif ($parentModuleName == 'Estimates' || $parentModuleName == 'Actuals') {
            $this->column_fields['cf_comment_type'] = '3';
        } elseif ($parentModuleName == 'Cubesheets') {
            $this->column_fields['cf_comment_type'] = '2';
        }
