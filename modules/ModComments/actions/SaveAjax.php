...
class ModComments_SaveAjax_Action extends Vtiger_SaveAjax_Action
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        if (!$request->get('relationOperation')) {
            $parentRecordModel = Vtiger_Record_Model::getInstanceById($request->get('related_to'));
            $CRMObject = new CRMEntity();
            $CRMObject->trackLinkedInfo($parentRecordModel->getModuleName(), $parentRecordModel->getId(), $recordModel->getModuleName(), $recordModel->getId());
        }
