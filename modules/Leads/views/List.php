    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        if (!empty($orderBy)) {
            ...
            if (getenv('IGC_MOVEHQ') || getenv('INSTANCE_NAME') == 'national') {
                $defaultSorting = $listViewModel->getDefaultSorting($cvId);
                if ($defaultSorting['sort_field'] && strtolower($defaultSorting['sort_field']) != 'none') {
                    $listViewModel->set('orderby', $defaultSorting['sort_field']);
                    $listViewModel->set('sortorder', $defaultSorting['sort_order']);
                }
            }
        }
