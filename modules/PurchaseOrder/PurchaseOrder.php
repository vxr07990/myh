...
class PurchaseOrder extends CRMEntity
{
    ...
    public $mandatory_fields = array('subject', 'vendor_id','createdtime' ,'modifiedtime', 'assigned_user_id');
    ...
    public function save_module($module)
    {
        ...
        if ($_REQUEST['action'] != 'PurchaseOrderAjax' && $_REQUEST['ajxaction'] != 'DETAILVIEW'
            ...
            } elseif ($this->column_fields['postatus'] === 'Received Shipment' && $this->mode != '') {        //Updating Product stock quantity during edit mode
                $recordId = $this->id;
