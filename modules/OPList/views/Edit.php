...
class OPList_Edit_View extends Vtiger_Edit_View
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        file_put_contents('logs/devLog.log', "\n ExtraPermissions : ".print_r($extraPermissions, true), FILE_APPEND);
        ...
        */
        ...
        //file_put_contents('logs/devLog.log', "\n ".print_r($recordModel->getOpListDataArray(),true),FILE_APPEND);
        //old securities
        /*
        file_put_contents('logs/devLog.log',
                          "\n This->getPermissionLevel() : ".print_r($this->getPermissionLevel(), true), FILE_APPEND);
        $viewer->assign('PERMISSION_LEVEL', $this->getPermissionLevel());
        */
