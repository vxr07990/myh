...
class Orders_Popup_View extends Vtiger_Popup_View
{
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        if (($request->get('popup_type') != '' && $request->get('popup_type') == 'trip_orders_related') || $request->get('src_module') == 'Trips') {
            $searchParmams[0][] = [
                'orders_assignedtrip',
                'e',
                '0',
        ...
        }else if($request->get('src_module') == 'ClaimsSummary'){ // Do not show OverFlow Orders
            $searchParmams[0][] = [
                'orders_no',
                'k', //NOT LIKE '% value %'
                'O/F',
