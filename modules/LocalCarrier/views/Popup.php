...
class LocalCarrier_Popup_View extends Vtiger_Popup_View
{
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        //$moduleName = 'LocalCarrier';
        //$relatedParentId = $agentid;
        //$relatedParentModule = 'AgentManager';
        //$label = 'Local Carriers';
