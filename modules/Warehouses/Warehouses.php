...
class Warehouses extends Vtiger_CRMEntity
{
    public $table_name = 'vtiger_warehouses';
    public $table_index= 'warehousesid';

    /**
     * Mandatory table for supporting custom fields.
     */
    public $customFieldTable = array('vtiger_warehousescf', 'warehousesid');
    ...
    public $tab_name_index = array(
        ...
        'vtiger_warehouses' => 'warehousesid',
        'vtiger_warehousescf'=>'warehousesid');
