...
class EmployeeRoles_Popup_View extends Vtiger_Popup_View
{
    /*
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        if($sourceModule == 'TimeSheets' && $sourceField == 'timesheet_personnelroleid'){
            $listViewModel->set('search_key', 'emprole_class_type');
            $listViewModel->set('search_value', 'Operations');
        }
        $searchRole = false;
        if(($sourceModule == 'Accounts' || $sourceModule == 'Leads' || $sourceModule == 'Opportunities' || $sourceModule == 'Orders') && $moduleName =='EmployeeRoles'){
            $searchRole = true;
        }

        if ((!empty($searchKey)) && (!empty($searchValue))) {
            if($searchKey == 'emprole_class_type'){
                if($sourceModule == 'Accounts' && $moduleName =='EmployeeRoles'){
                    $listViewModel->set('search_key', 'emprole_class_type');
                    $listViewModel->set('search_value', 'Office');
                }
            }else{
        ...
        if (!empty($relatedParentModule) && !empty($relatedParentId)) {
            ...
            $this->listViewEntries = $listViewModel->getListViewEntries($pagingModel,$searchRole);
        }
