...
class UserManagement_ListView_Model extends Vtiger_ListView_Model
{
...
//VGS Adding the new widget to the project dashboard
        ...
        if ($userPrivilegesModel->hasModuleActionPermission($projectTaskInstance->getId(), 'DetailView')) {
            $widgets[] = array(
                ...
                'linklabel' => 'Loading',
                'linkName' => 'Loading',
                'linkurl' => 'module=Project&view=Detail&mode=getResources&project_tasks=Loading&record=' . $this->getRecord()->getId(),
                'action' => array('Add'),
        ...
        if ($userPrivilegesModel->hasModuleActionPermission($projectTaskInstance->getId(), 'DetailView')) {
            $widgets[] = array(
                ...
                'linklabel' => 'Transit',
                'linkName' => 'Transit',
                'linkurl' => 'module=Project&view=Detail&mode=getResources&project_tasks=Transit&record=' . $this->getRecord()->getId(),
                'action' => array('Add'),
                'actionURL' => 'module=ResourceDashboard&view=ResourceSelect&taskname=Transit&projectid=' . $this->getRecord()->getId()
            );
        }
        ...
        if ($userPrivilegesModel->hasModuleActionPermission($projectTaskInstance->getId(), 'DetailView')) {
            $widgets[] = array(
                ...
                'linklabel' => 'Delivery',
                'linkName' => 'Delivery',
                'linkurl' => 'module=Project&view=Detail&mode=getResources&project_tasks=Delivery&record=' . $this->getRecord()->getId(),
                'action' => array('Add'),
                'actionURL' => 'module=ResourceDashboard&view=ResourceSelect&taskname=Delivery&projectid=' . $this->getRecord()->getId()
            );
        }
