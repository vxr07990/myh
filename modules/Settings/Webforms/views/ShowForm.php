    ...
    public function process(Vtiger_Request $request)
    {
        ...
        foreach ($selectedFieldsList as $fieldName => $fieldModel) {
            if (Settings_Webforms_Record_Model::isCustomField($fieldName)) {
                ...
                if ($dataType != 'picklist' && $dataType != 'multipicklist' && $dataType != 'multiagent') {
        ...
        $action_path = $trailing_slash_URL.'modules/Webforms/capture.php';
        $captchaPath = $trailing_slash_URL.'modules/Settings/Webforms/actions/CheckCaptcha.php';
