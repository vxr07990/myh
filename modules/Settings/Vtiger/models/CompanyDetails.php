...
class Settings_Vtiger_CompanyDetails_Model extends Settings_Vtiger_Module_Model
{
    ...
    {
        return 'index.php?module=System&parent=Settings&view=CompanyDetailsEdit';
    }
    ...
    public function getIndexViewUrl()
    {
        ...
        return 'index.php?module=System&parent=Settings&view=CompanyDetails&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
    }
