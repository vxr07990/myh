...
class Settings_Vtiger_Menu_Model extends Vtiger_Base_Model
{
    ...
    {
        return 'index.php?module=System&parent=Settings&view=ListMenu&block='.$this->getId();
    }
    ...
    public static function getAll()
    {
        ...
        if (!$currentUser->isAdminUser() && $currentUser->isParentVanLineUser()) {
            $restrictBlock[] = 'LBL_STUDIO';
            $restrictBlock[] = 'LBL_COMMUNICATION_TEMPLATES';
            //$restrictBlock[] = 'LBL_OTHER_SETTINGS';
            //$restrictBlock[] = 'LBL_INTEGRATION';
        }

        elseif (!$currentUser->isAdminUser() && $currentUser->isAgencyAdmin()) {
            $restrictBlock[] = 'LBL_STUDIO';
            $restrictBlock[] = 'LBL_COMMUNICATION_TEMPLATES';
            $restrictBlock[] = 'LBL_USER_MANAGEMENT';
            //$restrictBlock[] = 'LBL_INTEGRATION';
        }
