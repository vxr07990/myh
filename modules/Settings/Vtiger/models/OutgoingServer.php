...
class Settings_Vtiger_OutgoingServer_Model extends Settings_Vtiger_Systems_Model
{
    ...
    public function getBody()
    {
        ...
        return 'Dear '.$currentUser->get('user_name').', <br><br><b> This is a test mail sent to confirm if a mail is 
                ...
                <br><br>Thanks  and  Regards,<br> IGC Software <br><br>';
    }
    ...
    public function getEditViewUrl()
    {
        ...
        return '?module=System&parent=Settings&view=OutgoingServerEdit&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
    }
    
    public function getDetailViewUrl()
    {
        $menuItem = $this->getMenuItem();
        return '?module=System&parent=Settings&view=OutgoingServerDetail&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
    }
