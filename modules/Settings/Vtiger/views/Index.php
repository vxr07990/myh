...
class Settings_Vtiger_Index_View extends Vtiger_Basic_View
{
    ...
    public function checkPermission(Vtiger_Request $request)
    {
        ...
        $accesibleModules = $currentUserModel->getLowLevelAdminSettingAccess();

        if (!$currentUserModel->isAdminUser() && !in_array($module, $accesibleModules)) {
            throw new AppException(vtranslate('LBL_PERMISSION_DENIED', 'Vtiger'));
        }

        if (!$currentUserModel->isAdminUser() && !$currentUserModel->isAgencyAdmin() && !$currentUserModel->isParentVanLineUser()) {
            throw new AppException(vtranslate('LBL_PERMISSION_DENIED', 'Vtiger'));
        }
    }
