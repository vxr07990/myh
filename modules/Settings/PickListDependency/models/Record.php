...
class Settings_PickListDependency_Record_Model extends Settings_Vtiger_Record_Model
{
    ...
    public function getPickListDependency($agentManagerId = false)
    {
        if (empty($this->mapping)) {
            $dependency = Vtiger_DependencyPicklist::getPickListDependency($this->get('sourceModule'), $this->get('sourcefield'), $this->get('targetfield'),$agentManagerId);
