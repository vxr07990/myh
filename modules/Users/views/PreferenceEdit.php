...
class Users_PreferenceEdit_View extends Vtiger_Edit_View
{
    public function checkPermission(Vtiger_Request $request)
    {
        ...
        if (!empty($record)) {
            ...
            //This is an exception here, because we can't edit inactive users?
            //@TODO: Reconsider this throw.
            if ($recordModel->get('status') != 'Active' && $currentUserModel->isAdminUser() != true) {
                throw new AppException('LBL_PERMISSION_DENIED');
            }
            return true;
        } else if (
            ...
            //This is a new user record so we allow this set to create them.
            return true;
        } else {
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $jsFileNames           = [
            ...
            //'modules.Vtiger.resources.validator.PhoneValidator',
