...
//for Support end notification before a month
    ...
    {
        $fieldTypeInfo = array('multiagent' => array(200), 'picklist' => array(15, 16), 'text' => array(19, 20, 21, 24), 'autogenerated' => array(3), 'phone' => array(11),
    ...
    public function addEntriesForSettings()
    {
        ...
        $links = array(
            ...
            'index.php?parent=Settings&module=System&view=CompanyDetails',
            'index.php?parent=Settings&module=System&view=OutgoingServerDetail',
            'index.php?parent=Settings&module=Currency&view=List',
            'index.php?module=System&parent=Settings&view=TaxIndex',
            'index.php?module=Settings&submodule=Server&view=ProxyConfig',
            'index.php?parent=Settings&module=System&view=AnnouncementEdit',
            'index.php?module=Settings&action=DefModuleView&parenttab=Settings',
            'index.php?parent=Settings&module=System&view=TermsAndConditionsEdit',
            'index.php?module=System&parent=Settings&view=CustomRecordNumbering',
            'index.php?parent=Settings&module=MailConverter&view=List',
            'index.php?module=Workflows&parent=Settings&view=List',
            'index.php?module=System&parent=Settings&view=ConfigEditorDetail',
