...
/**
 * Class Notifications_Uninstall_View
 */
class Notifications_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function process(Vtiger_Request $request)
    {
        ...
        $notifications->removeRelatedModules($moduleName, $notifications->supportModules);
        $notifications->removeRelatedTo($moduleName, $notifications->supportModules);
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_notificationscf table
        echo "&nbsp;&nbsp;- Delete vtiger_notificationscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_notificationscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_notifications table
        echo "&nbsp;&nbsp;- Delete vtiger_notifications table.";
        $result = $adb->pquery("DROP TABLE vtiger_notifications");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
