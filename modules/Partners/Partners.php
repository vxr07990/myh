...
{
    public $table_name = 'vtiger_partners';
    public $table_index= 'partnersid';

    /**
     * Mandatory table for supporting custom fields.
     */
    public $customFieldTable = array('vtiger_partnerscf', 'partnersid');

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    public $tab_name = array('vtiger_crmentity', 'vtiger_partners', 'vtiger_partnerscf');
